...
§ 3º     O prazo que terminar em domingo ou feriado considera-se PRORROGADO até
         ...
         ⚠️ SÁBADO NÃO ESTÁ NO § 3º. Vencimento em sábado também se prorroga na
         prática, mas por AUSÊNCIA DE EXPEDIENTE FORENSE — não por este
         dispositivo. Citar o § 3º para sábado é citar norma que não diz aquilo.
...
> **⚠️ DIVERGÊNCIA REAL — e o motor adota a leitura mais curta de propósito.**
>
> Quando a publicação cai numa **sexta-feira**, as duas regras acima levam a datas
> diferentes:
>
> - **CPP 798, § 1º** — exclui-se o dia do começo e a contagem, sendo contínua,
>   corre a partir do dia imediato, **ainda que não útil** (sábado). Data **mais curta**.
> - **Lei 11.419/2006, art. 4º, § 4º** (e a linha acima) — o prazo tem início no
>   **primeiro dia útil seguinte** ao considerado data da publicação. Data **mais longa**.
>
> A `calculadora-tempestividade` adota a **mais curta**, e isso é decisão de
> segurança, não de doutrina: **protocolar pela data mais curta nunca perde prazo**;
> adotar a mais longa e errar, sim.
>
> **Mas o inverso também precisa ser dito ao(à) advogado(a):** a data mais curta é
> a segura **para protocolar**, não para **desistir**. Se o prazo curto passou, o
> recurso pode continuar tempestivo pela leitura da Lei 11.419 — nunca conclua que
> precluiu sem checar as duas contas.
>
> Regra prática: **adote a mais curta, registre a divergência, jamais a esconda.**
