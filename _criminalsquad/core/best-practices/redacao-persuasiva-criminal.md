---
name: "Redação Persuasiva Criminal (obra-prima forense)"
description: "A camada de maestria da escrita forense penal: teoria do caso, narrativa estratégica dos fatos, subsunção explícita, coesão argumentativa, persuasão ética e estilo — o que separa a peça correta da peça que convence"
whenToUse: |
  TODO agente que redige peça, parecer, memorial ou manifestação penal (redatores de squads e subagentes de peça),
  e todo revisor que avalia a qualidade retórica dessas peças. Complementa peticao-criminal.md e recurso-criminal.md
  (que dão a ESTRUTURA): esta best-practice governa a ESCRITA em si.
version: "1.0.0"
---

# Redação Persuasiva Criminal — a peça como obra-prima

A `peticao-criminal.md` e a `recurso-criminal.md` garantem a **arquitetura** (endereçamento, cabimento, prazos, capítulos, eventualidade). Esta best-practice governa o que acontece **dentro** dos capítulos: a narrativa, o argumento, a costura e o estilo. Uma peça pode estar formalmente perfeita e ainda assim ser fraca — blocos corretos sem tese que os organize, fatos copiados da denúncia, artigos citados que nunca tocam o caso concreto, dez ementas em cascata. O padrão aqui é outro: **peça que um desembargador leia sem esforço, entenda em uma passada e tenha dificuldade de negar.**
