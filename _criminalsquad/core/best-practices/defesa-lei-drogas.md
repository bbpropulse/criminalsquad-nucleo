...
| **Art. 33, caput** | Tráfico (18 núcleos — crime de **ação múltipla**) | Pena 5–15 anos. Perigo **abstrato/presumido**; consumação **independe** da tradição ao destinatário (DRG-013); **⚠️ materialidade sem apreensão — precedente PRÓ-ACUSAÇÃO** (ver nota abaixo) |
...
> ⚠️ **Materialidade sem apreensão: a polaridade do precedente é o que importa.** Há acórdão do
> STF admitindo a materialidade do tráfico por outros meios de prova mesmo **sem apreensão** do
> entorpecente (ARE 1.476.455 AgR/MS, 1ª Turma, unânime, abr/2024). **É precedente da ACUSAÇÃO** —
> quem venceu foi o Ministério Público, e o desfecho foi restabelecer condenação que o STJ havia
> derrubado. Num produto de defesa, ele serve para **antecipar e refutar**, jamais como fundamento
> defensivo: copiado para a peça, milita contra o cliente. Também **não é tese de repercussão
> geral** — é acórdão de Turma em agravo regimental, sem tema fixado. E o rótulo "materialidade
> indireta" **não é do Tribunal**: aparece nos autos apenas na alegação da defesa que perdeu.
>
> A tese **defensiva** sobre o ponto é outra e vive no STJ (exigência de laudo toxicológico
> definitivo) — **localize os julgados pelo gate** `jurisprudencia-stj-stf` antes de citar.
