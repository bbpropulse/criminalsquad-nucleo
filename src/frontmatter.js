...
//
// Tolera BOM UTF-8 (\uFEFF) no início: editores do Windows o gravam por padrão, e
// sem removê-lo o `^---` não casava — o SKILL.md inteiro deixava de ser
// reconhecido e o catálogo caía em cascata, justamente quando o aluno cria uma
// skill nova. O BOM é marca de codificação, não conteúdo.
