...
`Ante o exposto, requer:` o **recebimento e o processamento da presente Resposta Preliminar**; o **acolhimento da(s) preliminar(es)** (se houver); a **REJEIÇÃO da denúncia (ou queixa)** — nos crimes funcionais, por convencer-se o juízo, pela resposta, da **inexistência do crime** ou da **improcedência da ação** (art. 516 do CPP), sem prejuízo das hipóteses do art. 395; no **JECRIM**, o **não recebimento** (art. 81 da Lei 9.099/95); na **Lei de Drogas**, o **não recebimento** na decisão do art. 55, §4º, da Lei 11.343/06 — por [atipicidade / excludente, ex.: art. 24 CP / falta de justa causa]; **subsidiariamente, para o caso de recebimento**, a **juntada de documentos**, a **produção de provas** e a **inquirição das testemunhas** abaixo arroladas.

> ⚠️ **Aqui não se pede absolvição.** Esta peça é anterior ao recebimento: não há ação penal instaurada nem juízo de mérito, e o único desfecho que a lei prevê para esta fase é o juiz **rejeitar ou receber** a acusação. A absolvição sumária do art. 397 do CPP pertence à **Resposta à Acusação**, já depois do recebimento. As teses de teoria do crime servem aqui para fundamentar a **rejeição** — pedir absolvição é requerer provimento impossível e, pior, **deixar de formular o único pedido útil**, o que faz o juiz receber a denúncia sem enfrentar a questão.
...
- [ ] Pedidos: recebimento **da peça** + preliminar + **REJEIÇÃO / não recebimento da denúncia** + provas + testemunhas? (**absolvição não se pede nesta fase**)
