---
name: ep-simulador-julgador
description: >-
  Use para avaliar peça ou tese sob a perspectiva de juiz da execução ou relator. Não use para
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-simulador-julgador"]
...
Testar clareza, cabimento, prova, urgência e executabilidade do pedido pela perspectiva decisória.

# Quando usar

- Antes de protocolo ou julgamento.
- Quando a peça está longa ou complexa.
- Quando o pedido operacional pode ser confuso.
- Quando há risco de indeferimento por prova insuficiente.
...
1. Identificar o que o julgador precisa decidir.
2. Verificar se a peça apresenta fatos em ordem clara.
3. Verificar se a prova é suficiente.
4. Verificar se o pedido é juridicamente cabível.
5. Verificar se o pedido é operacionalmente cumprível.
6. Identificar perguntas que o julgador faria.
7. Apontar motivo provável de deferimento e indeferimento.
8. Sugerir ajustes para decisão favorável.
9. Classificar risco.
...
- A análise deve reduzir o esforço cognitivo do julgador para deferir o pedido.
...
A skill executa simulação de juiz/relator. Seu papel é impedir protocolo de material fraco, perigoso ou contraditório. Deve apontar problemas com franqueza e classificar gravidade.
