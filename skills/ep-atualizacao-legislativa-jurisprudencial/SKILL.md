---
name: ep-atualizacao-legislativa-jurisprudencial
description: >-
  Use para converter atualização legislativa, jurisprudencial ou normativa em impacto prático para
  execução penal e modelos do escritório. Não use para conclusão definitiva sem autos suficientes,
...
metadata:
  ...
  category: gestão, carteira e atendimento
  version: "3.0.0"
  risk_level: "r3"
  input_types:
    - lista_casos
  ...
  next_skills_sugeridas:
    - ep-banco-teses
    - ep-modelos-dinamicos-pecas
    - ep-dashboard-carteira
  type: "prompt"
  schema_version: "5"
  quality_profile: "legal-analysis"
  contract_version: "5.0.0"
  quality_status: "contracted"
  eval_case_ids: ["csq-v5-ep-atualizacao-legislativa-jurisprudencial"]
  delivery_type: "legal-analysis"
  freshness_policy: "official-current-source-required"
  positive_triggers: ["carteira", "atendimento", "alerta", "prazo", "cliente", "familia", "modelo", "tese"]
...
Analisar mudança normativa ou jurisprudencial e traduzi-la em providências: revisar modelos, reavaliar carteira, criar teses e atualizar checklists.

# Quando usar

- Quando sai lei nova, resolução, súmula, tema, repetitivo, repercussão geral ou decreto.
- Quando há mudança no STJ/STF/CNJ/tribunal local.
- Ao revisar base de conhecimento.
- Antes de mutirão de carteira.

# Entradas necessárias ou desejáveis

- Texto da atualização ou fonte oficial.
- Tema afetado.
- Modelos e teses atuais, se disponíveis.
- Carteira de casos, se disponível.

# Protocolo obrigatório

1. Identificar a fonte e vigência da atualização.
2. Resumir mudança em linguagem prática.
3. Identificar temas de execução afetados.
4. Avaliar direito intertemporal e retroatividade.
5. Identificar modelos e teses que precisam de revisão.
6. Indicar casos da carteira potencialmente impactados, se dados disponíveis.
7. Criar checklist de providências.
8. Sinalizar incertezas ou necessidade de acompanhamento.
9. Entregar alerta prático.
...
```json
{
  "skill": "ep-atualizacao-legislativa-jurisprudencial",
...
- Não emitir alerta normativo sem fonte oficial ou confiável.
- Não afirmar aplicação retroativa sem análise específica.
...
- A atualização deve gerar ação concreta no escritório.
...
# Doutrina operacional da categoria: gestão, carteira e atendimento

As skills desta categoria convertem informação jurídica em gestão de rotina: atendimento, carteira, prazos, teses, modelos e comunicação. Devem reduzir esquecimento, retrabalho e ruído com família/cliente.

## Regras específicas da categoria

- Não prometer resultado.
- Traduzir juridiquês em linguagem compreensível quando a saída for para cliente/família.
- Criar tarefas e responsáveis, não apenas diagnósticos.
- Indicar frequência de revisão: diária, semanal, mensal, anual ou por evento.
- Separar informação estratégica interna de comunicação externa.


# Núcleo técnico avançado desta skill

A skill deve transformar atualização normativa e jurisprudencial em rotina de alta performance. O foco é reduzir esquecimento, padronizar qualidade, criar ação e preservar comunicação clara.

## Perguntas críticas que a skill deve responder

- Qual informação é necessária agora?
- Qual informação é estratégica e interna?
- Qual deve ser comunicada ao cliente?
- Há prazo?
- Há documento faltante?
- Quem é responsável?
- Quando revisar?
- Qual status?
- Qual risco de esquecimento?
- Qual próximo passo?
...
4. criar tarefa
5. definir prazo interno
6. definir responsável
7. gerar comunicação adequada
8. marcar revisão
9. registrar risco
...
- alerta sem ação
- comunicação externa com tese sensível
...
# Padrão de operacionalização

Toda saída de gestão deve criar ação controlável:

```json
{
  "acao": "",
  "responsavel": "advogado | estagiario | paralegal | familia | cliente | sistema",
  "prazo_interno": "",
...
Para cliente/família, usar linguagem clara, sem prometer resultado, sem expor tese sensível desnecessária e diferenciando “é possível pedir” de “o juiz vai conceder”.
