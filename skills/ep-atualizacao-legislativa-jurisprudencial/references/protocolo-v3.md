...
- A novidade é normativa, jurisprudencial, administrativa ou operacional?
- Altera skills, modelos, carteira ou tese?
- Há direito intertemporal?
- Quais casos precisam ser revisados?
...
- Converter informação em prazo, responsável, documento e próxima ação.
- Não prometer resultado ao cliente/família.
- Classificar urgência antes de rotina administrativa.
- Usar linguagem simples quando o destinatário for família/cliente.
...
Mudança sobre progressão deve gerar lista de skills e modelos afetados, além de triagem de casos com fatos anteriores/posteriores.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["mudanca", "impacto_pratico", "skills_afetadas", "modelos_afetados", "carteira_a_revisar", "acao_recomendada"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    {"skill": "ep-banco-teses", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-modelos-dinamicos-pecas", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-dashboard-carteira", "motivo": "continuidade técnica recomendada"}
  ],
  "revisao_humana_obrigatoria": true
}
```
