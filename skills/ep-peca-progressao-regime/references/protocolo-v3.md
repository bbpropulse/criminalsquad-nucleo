...
- A progressão já foi validada por skill de cálculo?
- A prova subjetiva está junta?
- Há falta/exame a enfrentar?
- Há pedido subsidiário de harmonização?
- O pedido é operacionalmente cumprível?
...
A saída deve conter síntese executória, linha do tempo, cálculo do lapso, requisito subjetivo, pedidos e documentos anexos.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["analise_cabimento", "plano_da_peca", "minuta", "pedidos", "checklist_protocolo"]
  },
  "achados_criticos": [
