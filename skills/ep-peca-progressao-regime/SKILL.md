---
name: ep-peca-progressao-regime
description: >-
  Use para redigir pedido de progressão de regime com cálculo, requisito subjetivo, documentos, tese
  principal e pedido subsidiário. Não use para decisão final, assinatura, protocolo ou citação não
  verificada.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-peca-progressao-regime"]
...
Produzir minuta de pedido de progressão de regime em execução penal, com estrutura objetiva, cálculo auditável, prova do requisito subjetivo e pedidos operacionais.

# Quando usar

- Quando a análise indicou cabimento de progressão.
- Quando o lapso está vencido ou próximo.
- Quando se pretende pedir regime harmonizado subsidiariamente.
- Quando há necessidade de enfrentar falta grave ou exame criminológico.

# Entradas necessárias ou desejáveis

- Resultado da skill de progressão.
- Cálculo auditado.
- Linha do tempo.
- Atestado de conduta e certidão disciplinar.
- Documentos de remição.
- Exame criminológico ou decisão relacionada, se houver.
- Dados de regime e unidade.

# Protocolo obrigatório

1. Confirmar dados de endereçamento e identificação.
2. Abrir com resumo executivo do pedido.
3. Apresentar linha do tempo essencial.
4. Demonstrar requisito objetivo com cálculo.
5. Demonstrar requisito subjetivo com documentos.
6. Enfrentar falta grave, se houver.
7. Enfrentar exame criminológico, se houver.
8. Inserir tese jurídica e jurisprudência verificada.
9. Formular pedido principal de progressão.
10. Formular pedido subsidiário de harmonização/domiciliar/fiscalização se cabível.
11. Pedir atualização de cálculo, expedição de atos e intimações necessárias.
12. Listar documentos citados e pontos de revisão.
...
```json
{
  "skill": "ep-peca-progressao-regime",
...
A skill deve produzir pedido de progressão de regime com padrão de criminalista sênior: objetivo, documentado, com cálculo quando aplicável, tese clara, enfrentamento de riscos e pedido operacional executável.
...
- pedido subsidiário de harmonização
...
- lapso sem memória de cálculo
- subjetivo sem prova
- não enfrentar falta grave
- pedido sem providência de implantação
- fato sem fonte
