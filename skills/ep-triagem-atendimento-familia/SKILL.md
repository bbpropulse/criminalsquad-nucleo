---
name: ep-triagem-atendimento-familia
description: >-
  Use para conduzir atendimento inicial com família ou cliente preso, coletando dados, urgência e
  documentos para execução penal. Não use para compartilhamento de dados, promessa de resultado ou
...
metadata:
  ...
  next_skills_sugeridas:
    ...
    - ep-parecer-cliente-linguagem-simples
  type: "prompt"
  schema_version: "5"
  quality_profile: "client-operations"
  contract_version: "5.0.0"
  quality_status: "contracted"
  eval_case_ids: ["csq-v5-ep-triagem-atendimento-familia"]
...
Transformar atendimento inicial em ficha estruturada, identificando urgência, dados essenciais, documentos faltantes e próximos passos.

# Quando usar

- Primeiro contato com família.
- Primeiro atendimento da pessoa executada.
- Quando há informações desorganizadas.
- Antes de pedir acesso ao processo.

# Entradas necessárias ou desejáveis

- Relato da família/cliente.
- Documentos pessoais.
- Número do processo, se houver.
- Informações sobre unidade, pena, regime, saúde, faltas, trabalho/estudo e advogado anterior.

# Protocolo obrigatório

1. Coletar identificação da pessoa executada.
2. Coletar dados processuais disponíveis.
3. Coletar unidade e regime informado.
4. Coletar datas narradas: prisão, condenação, benefício, falta.
5. Coletar informações sobre saúde, ameaça e vulnerabilidade.
6. Coletar trabalho/estudo/remição.
7. Identificar urgência e risco.
8. Solicitar documentos essenciais.
9. Explicar próximos passos em linguagem simples.
10. Gerar ficha e checklist.
...
```json
{
  "skill": "ep-triagem-atendimento-familia",
...
- A ficha deve permitir continuidade do caso por outro membro da equipe.
...
A skill deve transformar atendimento inicial com família/cliente em rotina de alta performance. O foco é reduzir esquecimento, padronizar qualidade, criar ação e preservar comunicação clara.
