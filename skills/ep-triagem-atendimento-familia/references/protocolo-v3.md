...
- Qual é a prioridade?
- Qual próximo prazo ou benefício?
...
A skill deve converter informação em ação, prazo e responsável.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["prioridade", "alertas", "documentos_solicitados", "plano_acao", "mensagem"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    {"skill": "ep-triagem-inicial-execucao", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-beneficios-vencidos-detector", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-parecer-cliente-linguagem-simples", "motivo": "continuidade técnica recomendada"}
  ],
  "revisao_humana_obrigatoria": true
}
```
