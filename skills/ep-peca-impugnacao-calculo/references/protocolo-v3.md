...
- Qual erro concreto será impugnado?
- Qual prova demonstra o erro?
- Qual é o cálculo correto?
- Qual benefício muda com a correção?
- Há pedido operacional de novo atestado?
...
Cálculo oficial desconsiderou detração e remição; a peça deve conter tabela oficial vs defensiva e pedido de retificação imediata.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["analise_cabimento", "quadro_comparativo", "minuta", "pedidos_operacionais", "documentos_anexar"]
  },
  "achados_criticos": [
