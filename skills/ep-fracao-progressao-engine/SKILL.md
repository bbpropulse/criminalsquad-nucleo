---
name: ep-fracao-progressao-engine
description: >-
  Use para identificar a fração correta de progressão, considerando crime, reincidência, violência,
  hediondez e direito intertemporal. Não use para escolha automática de lei, fração, marco ou
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-fracao-progressao-engine"]
...
Definir a fração de progressão mais adequada e seus cenários, sem hard-code acrítico, exigindo verificação da lei vigente, data do fato e jurisprudência atualizada.

# Quando usar

- Antes de calcular progressão.
- Quando houver crime hediondo/equiparado, violência, grave ameaça ou resultado morte.
- Quando houver reincidência genérica ou específica.
- Quando leis sucessivas podem alterar o lapso.

# Entradas necessárias ou desejáveis

- Condenações individualizadas.
- Artigos penais.
- Data do fato de cada crime.
- Informação de reincidência.
- Sentença, acórdão e guia.
- Cálculo oficial.

# Protocolo obrigatório

1. Listar cada condenação e sua data do fato.
2. Classificar a natureza jurídica do crime apenas com base documental.
3. Identificar se há violência, grave ameaça, resultado morte, hediondez, equiparação ou causa de tratamento específico.
4. Identificar reincidência e sua natureza conforme documentos.
5. Verificar lei aplicável na data do fato e alterações posteriores.
6. Avaliar retroatividade benéfica e irretroatividade gravosa.
7. Indicar fração principal, fração alternativa e risco jurisprudencial.
8. Explicar impacto da fração no cálculo.
9. Indicar documentos faltantes para confirmar premissas.
...
```json
{
  "skill": "ep-fracao-progressao-engine",
  "status": "concluido | concluido_com_ressalvas | bloqueado",
  "resultado": {
    "fracao_progressao": {
      "fracao_principal": "",
      "fundamento_premissas": "",
      "fracao_alternativa": "",
      "tese_intertemporal": "",
      "risco_jurisprudencial": "",
      "impacto_no_calculo": "",
...
- Não classificar reincidência específica sem decisão ou guia que permita essa conclusão.
- Não usar frações desatualizadas sem alerta de verificação normativa.
...
- A skill deve ser conservadora quando os dados de natureza do crime ou reincidência forem incompletos.
...
A skill deve identificar a fração correta de progressão a partir de variáveis penais e executórias. O risco está em aplicar percentual errado por ignorar natureza do crime, reincidência, resultado, violência ou lei no tempo.

## Perguntas críticas que a skill deve responder

- Qual é a data do fato?
- Qual lei era vigente?
- O crime é comum, hediondo ou equiparado?
- Houve violência ou grave ameaça?
- Houve resultado morte?
- Há reincidência? Qual tipo?
- Há tráfico privilegiado?
- Há condenações diversas com frações diferentes?
- Há tese de retroatividade benéfica?
- Há precedente vinculante ou controvérsia?
...
- acórdão
- guia
- certidão de antecedentes/reincidência
- cálculo
- lei atualizada
...
1. Extrair crimes
2. extrair datas dos fatos
3. classificar natureza de cada crime
4. verificar reincidência
5. mapear lei aplicável
6. aplicar direito intertemporal
7. separar fração por condenação se necessário
8. gerar cenário conservador e defensivo
9. indicar risco jurisprudencial

## Armadilhas e erros de alta gravidade

- usar uma única fração para penas heterogêneas sem justificar
- confundir reincidência genérica e específica
- ignorar data do fato
- aplicar lei mais gravosa retroativamente
- usar classificação não documentada
