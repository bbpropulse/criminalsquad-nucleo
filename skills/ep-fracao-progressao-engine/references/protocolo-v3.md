...
- Qual a data do fato?
- Qual natureza jurídica do delito?
- Há violência/grave ameaça ou resultado morte?
- Qual espécie de reincidência?
- A lei nova é benéfica ou gravosa?
- Há lacuna ou tese jurisprudencial?
...
Condenação por delito hediondo sem resultado morte e reincidência genérica; a skill deve propor fração, cenário defensivo e risco de entendimento local.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["fracao_principal", "fracao_subsidiaria", "premissas_crime", "premissas_reincidencia", "direito_intertemporal", "risco_jurisprudencial"]
  },
  "achados_criticos": [
