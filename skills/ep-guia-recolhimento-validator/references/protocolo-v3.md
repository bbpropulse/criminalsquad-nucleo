...
```json
{
  "skill": "ep-guia-recolhimento-validator",
  "case_id": "",
  "task_id": "",
  "modo": "parecer_interno|minuta_protocolavel|checklist|resumo_cliente|saida_estruturada",
...
- A guia é provisória ou definitiva?
- Contém sentença/acórdão, pena, regime, data do fato, trânsito e prisão?
- Há divergência com cálculo ou atestado?
- Falta dado que impede benefício?
- Qual retificação ou complementação pedir?
...
Guia sem data do fato e sem trânsito para acusação/defesa; a skill deve bloquear fração definitiva e recomendar complementação.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["tipo_guia", "dados_obrigatorios_presentes", "dados_faltantes", "divergencias", "impacto_calculo", "providencia"]
  },
  "achados_criticos": [
