...
- Nunca substituir prova por intuição.
- Não aceitar cálculo, falta grave ou indeferimento como verdade sem auditoria.
- Sempre procurar excesso de execução e rota de liberdade.
- Construir tese principal e tese de contenção de dano.
