---
name: ep-raciocinio-defensivo-multiteses
description: >-
  Use para gerar múltiplas teses defensivas, subsidiárias, recursais e humanitárias diante de
  problema de execução penal. Não use para conclusão definitiva sem autos suficientes, fonte atual
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-raciocinio-defensivo-multiteses"]
...
Transformar um problema executório em um conjunto de rotas defensivas hierarquizadas, com tese principal, teses subsidiárias, teses de nulidade, teses de excesso, teses humanitárias e instrumentos adequados.

# Quando usar

- Quando houver indeferimento de benefício.
- Quando houver cálculo controvertido.
- Quando houver PAD, falta grave, regressão ou laudo desfavorável.
- Quando o advogado quiser alternativas estratégicas antes de escolher a peça.

# Entradas necessárias ou desejáveis

- Resumo do caso.
- Decisão, cálculo, PAD, laudo ou ato impugnado.
- Documentos disponíveis.
- Objetivo prático desejado: liberdade, progressão, remição, anulação, retificação, urgência ou proteção.

# Protocolo obrigatório

1. Identificar a consequência jurídica principal que prejudica a pessoa executada.
2. Mapear teses de legalidade estrita.
3. Mapear teses constitucionais e de proporcionalidade.
4. Mapear teses probatórias.
5. Mapear teses de nulidade procedimental.
6. Mapear teses de direito intertemporal, se houver lei nova ou fração controversa.
7. Mapear teses humanitárias ou de vulnerabilidade, se houver fatos concretos.
8. Indicar instrumento processual provável para cada tese.
9. Classificar cada tese por força, risco, urgência e documentos necessários.
10. Entregar quadro multiteses.
...
```json
{
  "skill": "ep-raciocinio-defensivo-multiteses",
  "status": "concluido | concluido_com_ressalvas | bloqueado",
  "resultado": {
    "teses": [
      {
        "tipo": "principal | subsidiaria | nulidade | excesso | humanitaria | intertemporal | recursal",
        "tese": "",
        "fundamento": "",
        "prova_necessaria": [],
        "instrumento": "",
...
- Deve oferecer teses compatíveis entre si ou explicar conflito entre teses.
- Deve evitar teses meramente retóricas sem consequência prática.
...
A skill deve transformar cada problema em múltiplas rotas. Execução penal de alta performance raramente depende de uma tese única: cálculo, nulidade, prova, proporcionalidade, direito intertemporal e urgência podem coexistir.

## Perguntas críticas que a skill deve responder

- Qual é o ato que prejudica a pessoa executada?
- A tese principal ataca fato, prova, procedimento, cálculo ou fundamento jurídico?
- Há nulidade autônoma?
- Há excesso de execução?
- Há argumento constitucional ou convencional?
- Há tese intertemporal?
- Há alternativa de menor resistência para o juiz?
- Qual tese pode ser usada em HC e qual exige agravo?
- Qual tese depende de documento ainda ausente?
- Qual tese pode piorar a situação se mal formulada?
...
1. Identificar consequência concreta
2. listar teses por eixo
3. testar compatibilidade entre teses
4. atribuir força e risco
5. indicar instrumento cabível
6. indicar prova mínima
7. prever resposta do MP
8. prever fundamentação provável do juiz
9. selecionar tese prioritária
10. produzir mapa multiteses

## Armadilhas e erros de alta gravidade

- tese subsidiária contraditória sem explicação
- argumento emocional sem prova
- uso de jurisprudência não conferida
- excesso de teses fracas diluindo a tese forte
