...
- **Art. 117 da LEP** — hipóteses de **prisão domiciliar** do apenado no regime aberto, base da domiciliar do art. 146-B, IV: condenado **maior de 70 anos** (I), condenado acometido de **doença grave** (II), **condenada** com filho menor ou deficiente físico ou mental (III) e **condenada gestante** (IV). ⚠️ **Dois pontos que a peça costuma errar:** o inciso I é **70 anos**, não "idoso" (que começa aos 60 no Estatuto do Idoso) — são dez anos de diferença no gatilho; e os incisos III e IV estão **no feminino**, de modo que a extensão ao pai é construção pretoriana, a ser sustentada **como tal**, não como letra do art. 117. Some-se a domiciliar **por falta de vaga** em regime adequado (SV 56/STF). Ver skill `execucao-prisao-domiciliar-apenado`.
...
- **Domiciliar humanitária (art. 117 LEP):** maior de **70 anos**, doente grave, condenada gestante, condenada com filho menor/deficiente — a tornozeleira ampara a concessão diante de eventual resistência. Fora desses gatilhos literais (apenado de 60 a 69 anos, pai de filho menor), o fundamento é humanitário/proporcionalidade, não o texto do art. 117.

### Quando a defesa IMPUGNA a imposição

- **Falta de previsão legal para a hipótese:** o art. 146-B traz **rol de hipóteses**, e impor tornozeleira fora dele — ou como "condição genérica" de progressão sem previsão — é **ilegal**. ⚠️ **Abra o rol vigente antes de sustentar a taxatividade:** a **Lei 14.843/2024** mexeu no art. 146-B, e sustentar em plenário/petição que ele se resume a "saída temporária e domiciliar" sem conferir é dar ao MP a réplica mais barata que existe. A tese é a **taxatividade**; o **conteúdo do rol** vem da fonte oficial, não da memória.
...
- **T2 — Taxatividade do art. 146-B:** a monitoração só cabe nas hipóteses do rol; imposição fora dele é ilegal. **Confira o rol vigente antes de enumerá-lo** — a Lei 14.843/2024 alterou o dispositivo.
...
- **CT2:** o apenado tinha o **dever** de zelar pelo equipamento (art. 146-C, **II** — abster-se de remover, violar, modificar ou danificar o dispositivo, ou permitir que outrem o faça; o *caput* tem só os incisos I e II, e o III foi vetado — não existe inciso V) e falhou. **Rebater:** descumprimento de dever admite **gradação** (advertência) e depende de prova de negligência/dolo; não gera regressão automática.
