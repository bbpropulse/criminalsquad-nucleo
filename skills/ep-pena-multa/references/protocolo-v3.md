...
- A multa está executada em qual via?
- Houve pagamento, parcelamento ou inscrição?
- Há hipossuficiência comprovada?
- Há reflexo indevido em benefícios ou extinção?
- Qual pedido resolve?
...
Pessoa hipossuficiente com pena privativa cumprida e multa pendente; a skill deve separar extinção da privativa, cobrança e tese aplicável.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["valor", "status_execucao", "hipossuficiencia", "reflexos", "pedido_recomendado"]
  },
  "achados_criticos": [
