...
- **Toda célula de versão ou prova carrega a âncora**: fls. exata; se a fonte é mídia, **minutagem + referência à degravação** (nunca "de ouvido" — sem transcrição, acione a skill `captura-midia-av` antes de preencher).
...
| Preencher célula de mídia "de ouvido" | Erro de conteúdo grave; impugnação certa | Degravação antes (skill `captura-midia-av`); citar minutagem + fls. da transcrição |
