...
```json
{
  ...
  "resultado_principal": {
    "status_revisao": "aprovada|aprovada_com_ressalvas|bloqueada",
    "bloqueios": [],
...
- A via é cabível?
- A tese enfrenta o ponto decisivo?
- Os pedidos são coerentes e operacionais?
- Há tese perigosa ou sem prova?
- Há melhor via ou pedido subsidiário?
...
- Operar em modo red team: procurar o erro que derruba a peça.
- Não reescrever por estilo antes de corrigir falhas de prova, cálculo e cabimento.
- Separar falha bloqueante de melhoria recomendada.
- Apontar objeção provável do MP ou do julgador.
...
Peça de progressão sem certidão disciplinar: deve bloquear ou aprovar com ressalva forte conforme urgência e possibilidade de requisição.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["status_revisao", "problemas_criticos", "melhorias", "risco_de_protocolo", "versao_recomendada"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    {"skill": "ep-editor-persuasivo", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-antifalucinacao-juridica", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-simulador-ministerio-publico", "motivo": "continuidade técnica recomendada"}
  ],
  "revisao_humana_obrigatoria": true
}
```
