---
name: ep-monitoracao-eletronica
description: >-
  Use para analisar imposição, manutenção, descumprimento, falha técnica ou retirada de monitoração
  eletrônica. Não use para conclusão definitiva sem autos suficientes, fonte atual ou revisão
  profissional.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-monitoracao-eletronica"]
...
Avaliar tornozeleira eletrônica como condição de execução, identificando legalidade, proporcionalidade, relatórios técnicos, falhas e risco de regressão.

# Quando usar

- Quando foi imposta monitoração eletrônica.
- Quando há suposto descumprimento.
- Quando há falha de sinal, bateria ou rompimento.
- Quando se pretende retirar ou flexibilizar condições.
- Quando descumprimento pode gerar regressão.

# Entradas necessárias ou desejáveis

- Decisão que impôs monitoração.
- Termo de condições.
- Relatórios da central.
- Comunicações do monitorado.
- Comprovantes de justificativa.
- Decisão de advertência, regressão ou revogação.

# Protocolo obrigatório

1. Identificar base e finalidade da monitoração.
2. Listar condições impostas e prazos.
3. Analisar cada ocorrência de descumprimento.
4. Verificar se há relatório técnico completo.
5. Distinguir violação voluntária de falha técnica ou justificativa plausível.
6. Avaliar proporcionalidade da consequência.
7. Verificar se houve prévia oportunidade de justificativa.
8. Indicar pedido de manutenção, retirada, flexibilização ou anulação de consequência.
9. Listar provas técnicas e pessoais necessárias.
10. Entregar quadro de ocorrências.
...
```json
{
  "skill": "ep-monitoracao-eletronica",
  "status": "concluido | concluido_com_ressalvas | bloqueado",
  "resultado": {
    "monitoracao": {
      "condicoes": [],
      "ocorrencias": [],
      "risco_regressao": "alto | medio | baixo",
      "falhas_tecnicas_possiveis": [],
      "justificativas": [],
      "pedido_recomendado": "",
...
- A análise deve exigir relatório técnico antes de aceitar consequência gravosa.
...
Monitoração pode viabilizar liberdade ou gerar regressão. A skill deve tratar relatórios técnicos com rigor e distinguir falha real de falha de equipamento/sinal.

## Perguntas críticas que a skill deve responder

- Qual decisão impôs a tornozeleira?
- Quais condições?
- Qual prazo?
- Qual ocorrência?
- Há relatório técnico completo?
- Houve falha de sinal/bateria?
- A pessoa comunicou a central?
- O descumprimento foi relevante?
- A consequência é proporcional?
- Cabe retirada ou flexibilização?
...
4. verificar falha técnica
5. coletar justificativa
6. avaliar proporcionalidade
7. definir defesa ou pedido de retirada

## Armadilhas e erros de alta gravidade

- regressão por perda curta de sinal
- relatório incompleto
- zona mal definida
- condição impossível de cumprir
- falta de advertência prévia quando relevante
