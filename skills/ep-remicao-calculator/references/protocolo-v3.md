...
- A atividade é trabalho, estudo, leitura, curso ou exame?
- Há documento de frequência/aproveitamento?
- A remição está homologada ou pendente?
- Pode cumular trabalho e estudo?
- Qual impacto em progressão e término?
...
Certificados indicam 360 horas de estudo, mas só parte foi homologada; a skill deve separar dias seguros e dias dependentes de homologação.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["atividades", "dias_identificados", "dias_homologados", "dias_pendentes", "impacto_progressao", "impacto_livramento", "impacto_termino"]
  },
  "achados_criticos": [
