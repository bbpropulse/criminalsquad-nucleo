---
name: ep-remicao-calculator
description: >-
  Use para calcular remição por trabalho, estudo, leitura, cursos e atividades educativas, com
  impacto no cálculo da pena. Não use para escolha automática de lei, fração, marco ou consequência
  jurídica.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-remicao-calculator"]
...
Calcular dias de remição identificados, homologados, pendentes e contestáveis, indicando documentos, critérios, impacto na progressão e término de pena.

# Quando usar

- Ao receber certificados de trabalho, estudo, leitura ou cursos.
- Quando houver remição pendente ou não lançada.
- Antes de progressão, livramento ou término.
- Quando falta grave gerou perda de remição.

# Entradas necessárias ou desejáveis

- Certificados de curso, estudo, leitura ou trabalho.
- Relatórios de frequência e aproveitamento.
- Decisões de homologação de remição.
- Cálculo oficial.
- Decisões de perda de remição por falta grave.
- Normas aplicáveis e critérios locais.

# Protocolo obrigatório

1. Classificar cada atividade remível.
2. Extrair período, carga horária, frequência e aproveitamento.
3. Separar remição já homologada de remição pendente.
4. Aplicar critérios normativos vigentes e jurisprudência atualizada.
5. Verificar cumulação possível de atividades.
6. Verificar perda de remição e limite aplicado.
7. Calcular dias totais, homologados e pendentes.
8. Apontar impacto na progressão, livramento e término.
9. Indicar documentos faltantes ou inconsistentes.
10. Entregar cálculo e minuta técnica, se solicitado.
...
- A resposta deve separar remição certa de remição a requerer.
...
Remição pode antecipar liberdade e corrigir cálculo. A skill deve distinguir remição documentada, homologada, pendente e potencial, calculando impacto de forma separada.

## Perguntas críticas que a skill deve responder

- Qual atividade gerou remição?
- Qual período?
- Há certificado/frequência/aproveitamento?
- A remição foi homologada?
- Há remição pendente?
- Há falta grave com perda de remidos?
- A atividade é acumulável?
- Qual impacto na progressão?
- Qual impacto no término?
- Há necessidade de requisitar documentos à unidade?
...
- histórico escolar/trabalho
- atestados da unidade
- decisões de perda de remição

## Protocolo ampliado de alta performance

1. Classificar atividade
2. extrair período e carga horária/dias
3. verificar comprovação
4. separar homologada e pendente
5. aplicar regra vigente
6. calcular dias
7. avaliar perda por falta grave
8. calcular impacto
9. gerar pedido

## Armadilhas e erros de alta gravidade

- contar certificado sem carga horária
- contar remição pendente como homologada
- não considerar perda de até fração legal quando aplicável
- duplicar atividade
- ignorar aproveitamento exigido
