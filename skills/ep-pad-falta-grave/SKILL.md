---
name: ep-pad-falta-grave
description: >-
  Use para analisar PAD, falta grave, nulidades, prova, homologação e efeitos em progressão,
  remição, livramento e indulto. Não use para conclusão definitiva sem autos suficientes, fonte
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-pad-falta-grave"]
...
Auditar procedimento disciplinar e falta grave para identificar nulidades, fragilidade probatória, consequências executórias e estratégia defensiva.

# Quando usar

- Ao receber notícia de falta grave.
- Antes ou durante PAD.
- Após homologação judicial de falta.
- Quando falta impacta cálculo, progressão, remição ou mérito.
- Ao preparar defesa ou agravo.

# Entradas necessárias ou desejáveis

- Portaria de instauração do PAD.
- Relatório de ocorrência.
- Depoimentos, vídeos, imagens, livro de ocorrência ou outros elementos.
- Defesa administrativa.
- Decisão administrativa e homologação judicial.
- Cálculo antes/depois.
- Certidão disciplinar.

# Protocolo obrigatório

1. Identificar fato imputado, data e tipificação.
2. Verificar competência e instauração do PAD.
3. Verificar defesa técnica, intimações, oitiva e produção probatória.
4. Analisar individualização da conduta.
5. Identificar contradições e lacunas probatórias.
6. Verificar prescrição ou prazos administrativos relevantes.
7. Verificar decisão administrativa e homologação judicial.
8. Mapear efeitos na progressão, remição, livramento, indulto e requisito subjetivo.
9. Identificar nulidades e teses de mérito.
10. Indicar peça ou providência adequada.
...
```json
{
  "skill": "ep-pad-falta-grave",
  "status": "concluido | concluido_com_ressalvas | bloqueado",
  "resultado": {
    "falta_grave": {
      "validade": "valida | questionavel | nula | depende",
      "nulidades": [],
      "fragilidades_probatórias": [],
      "efeitos": {
        "progressao": "",
        "remicao": "",
        "livramento": "",
...
- A análise deve impedir aceitação automática de falta grave sem PAD e prova.
...
Falta grave pode destruir estratégia de liberdade. A skill deve analisar fato, tipicidade, procedimento, prova, defesa técnica, homologação e efeitos específicos.

## Perguntas críticas que a skill deve responder

- Qual fato é imputado?
- Quando ocorreu?
- Qual tipo disciplinar?
- Houve portaria?
- Houve defesa técnica?
- Houve oitiva?
- Houve testemunhas/imagens?
- A conduta foi individualizada?
- Houve homologação judicial?
- Quais efeitos em progressão/remição/livramento/indulto?
...
1. Identificar imputação
2. validar tipicidade
3. validar procedimento
4. validar prova
5. detectar nulidades
6. avaliar proporcionalidade
7. separar efeitos por benefício
8. definir defesa/recurso

## Armadilhas e erros de alta gravidade

- ausência de defesa técnica
- relato genérico de agente sem individualização
- homologação automática
- perda de remição sem fundamentação
- data-base alterada indevidamente
