...
- Há nulidade, prescrição ou desproporção?
- Quais efeitos são juridicamente possíveis?
...
- Separar consequência administrativa de consequência judicial.
- Verificar contraditório, defesa, prova e individualização antes de aceitar efeitos executórios.
- Em regressão, sempre verificar proporcionalidade e medida menos gravosa.
- Quando houver urgência, indicar instrumento mais rápido e prova pré-constituída.
...
PAD por posse de celular sem defesa técnica; a skill deve apontar nulidade, efeitos indevidos e peça recomendada.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["validade_pad", "nulidades", "prova", "tipicidade_disciplinar", "efeitos_progressao", "efeitos_remicao", "efeitos_livramento", "estrategia"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    {"skill": "ep-peca-defesa-pad", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-defesa-regressao", "motivo": "continuidade técnica recomendada"},
