...
- **Ética por instituição:** advocacia (OAB + Prov. 205/2021); Ministério Público (CNMP); Defensoria (LC 80/94). Conflito de interesses (art. 15, § 6º, EAOAB + CED 19-21) checado na triagem — comum em casos com múltiplos gestores/empresas coacusados.
