---
name: ep-peca-habeas-corpus-execucao
description: >-
  Use para redigir habeas corpus em execução penal diante de ilegalidade flagrante, excesso, regime
  mais gravoso, alvará não cumprido ou regressão ilegal. Não use para decisão final, assinatura,
...
metadata:
  ...
  next_skills_sugeridas:
    ...
    - ep-simulador-julgador
  type: "prompt"
  schema_version: "5"
  quality_profile: "legal-drafting"
  contract_version: "5.0.0"
  quality_status: "contracted"
  eval_case_ids: ["csq-v5-ep-peca-habeas-corpus-execucao"]
...
Produzir minuta de habeas corpus com prova pré-constituída, constrangimento ilegal claro, pedido liminar e pedido definitivo.

# Quando usar

- Quando há ilegalidade flagrante na execução.
- Quando a pessoa cumpre regime mais gravoso.
- Quando há prisão além do término.
- Quando alvará não foi cumprido.
- Quando regressão ou indeferimento é manifestamente ilegal.
- Quando há urgência de liberdade ou regime.

# Entradas necessárias ou desejáveis

- Decisão ou omissão coatora.
- Prova pré-constituída.
- Cálculo ou documentos que demonstrem ilegalidade.
- Dados da autoridade coatora.
- Dados do paciente.
- Linha do tempo.

# Protocolo obrigatório

1. Identificar paciente e autoridade coatora.
2. Definir constrangimento ilegal em uma frase.
3. Demonstrar prova pré-constituída.
4. Organizar linha do tempo mínima.
5. Demonstrar urgência e risco atual.
6. Enfrentar cabimento da via quando necessário.
7. Fundamentar com lei e jurisprudência verificada.
8. Formular pedido liminar específico.
9. Formular pedido definitivo.
10. Listar documentos indispensáveis e revisão.
...
```json
{
  "skill": "ep-peca-habeas-corpus-execucao",
...
A skill deve produzir habeas corpus em execução penal com padrão de criminalista sênior: objetivo, documentado, com cálculo quando aplicável, tese clara, enfrentamento de riscos e pedido operacional executável.
...
- HC com necessidade de dilação probatória
- sem decisão impugnada
- liminar sem urgência concreta
- fato sem fonte
