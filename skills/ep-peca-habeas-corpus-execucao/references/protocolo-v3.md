...
- Há restrição direta à liberdade?
- A ilegalidade é flagrante?
- A prova é pré-constituída?
- Há urgência real?
- A via não exige dilação probatória?
...
Paciente mantido em regime mais gravoso após decisão de progressão; a skill deve priorizar liminar com prova pré-constituída.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["cabimento_hc", "autoridade_coatora", "constrangimento", "prova_preconstituida", "liminar", "minuta"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    ...
    {"skill": "ep-simulador-julgador", "motivo": "continuidade técnica recomendada"}
  ],
  "revisao_humana_obrigatoria": true
}
```
