...
- O trabalho pode ser aprovado?
- Há falha bloqueante?
- Há inconsistência de fato, prova, cálculo ou jurisprudência?
- Qual correção é obrigatória?
...
A skill deve agir como red team e não como editor complacente.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["status_revisao", "bloqueios", "correcoes", "riscos", "melhorias"]
  },
  "achados_criticos": [
