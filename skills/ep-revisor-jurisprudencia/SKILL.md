---
name: ep-revisor-jurisprudencia
description: >-
  Use para validar jurisprudência citada: existência, atualização, aplicabilidade, força vinculante
  e riscos. Não use para conclusão definitiva sem autos suficientes, fonte atual ou revisão
  profissional.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-revisor-jurisprudencia"]
...
Verificar se precedentes, súmulas e temas citados existem, são atuais, aplicam-se ao caso e não foram usados de forma enganosa.

# Quando usar

- Antes de protocolo de peça com jurisprudência.
- Ao preparar recurso.
- Quando a tese depende de STJ/STF.
- Quando há decisão recente ou tema controvertido.

# Entradas necessárias ou desejáveis

- Lista de precedentes citados.
- Trechos da peça.
- Tese jurídica.
- Dados fáticos do caso.
- Fontes ou links dos precedentes.

# Protocolo obrigatório

1. Listar todos os precedentes e enunciados citados.
2. Verificar fonte e existência.
3. Classificar como vinculante, repetitivo, repercussão geral, súmula, informativo, acórdão ou decisão isolada.
4. Verificar data e atualidade.
5. Comparar fatos do precedente com o caso.
6. Identificar precedentes contrários relevantes.
7. Sugerir substituição ou distinção.
8. Bloquear citações sem fonte verificável.
9. Entregar relatório de jurisprudência.
...
- Bloquear jurisprudência inventada ou sem identificação suficiente.
- Bloquear citação cuja tese não corresponda ao precedente.
...
- A revisão deve impedir uso ornamental de jurisprudência.
...
A skill executa revisão jurisprudencial. Seu papel é impedir protocolo de material fraco, perigoso ou contraditório. Deve apontar problemas com franqueza e classificar gravidade.
...
- está atualizado
- aplica ao caso
- é vinculante/persuasivo
- há precedente contrário
