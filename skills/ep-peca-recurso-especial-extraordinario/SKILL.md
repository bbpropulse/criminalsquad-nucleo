---
name: ep-peca-recurso-especial-extraordinario
description: >-
  Use para estruturar recurso especial ou extraordinário em matéria de execução penal, verificando
  prequestionamento, óbices e tese. Não use para decisão final, assinatura, protocolo ou citação não
  verificada.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-peca-recurso-especial-extraordinario"]
...
Produzir minuta ou roteiro de recurso aos tribunais superiores, verificando admissibilidade, prequestionamento, matéria federal/constitucional e riscos.

# Quando usar

- Após acórdão desfavorável em execução penal.
- Quando há tese federal ou constitucional relevante.
- Quando há divergência jurisprudencial.
- Quando embargos de declaração podem ser necessários antes.

# Entradas necessárias ou desejáveis

- Acórdão recorrido.
- Embargos e acórdão dos embargos, se houver.
- Tese jurídica.
- Precedentes.
- Provas/documentos essenciais.
- Data de intimação.
- Histórico recursal.

# Protocolo obrigatório

1. Identificar se a matéria é federal, constitucional ou ambas.
2. Verificar prequestionamento.
3. Verificar necessidade de embargos prévios.
4. Identificar óbices prováveis de admissibilidade.
5. Separar reexame de prova de questão de direito.
6. Definir tese recursal.
7. Selecionar precedentes e temas aplicáveis.
8. Redigir estrutura do recurso ou roteiro de admissibilidade.
9. Formular pedidos.
10. Listar riscos e pontos de revisão.
...
```json
{
  "skill": "ep-peca-recurso-especial-extraordinario",
  "status": "concluido | concluido_com_ressalvas | bloqueado",
  "resultado": {
    "minuta_ou_roteiro": "",
    "tipo_recurso": "REsp | RE | ambos",
    "prequestionamento": "",
    "questao_de_direito": "",
    "obices": [],
    "precedentes": [],
...
A skill deve produzir recurso especial ou extraordinário com padrão de criminalista sênior: objetivo, documentado, com cálculo quando aplicável, tese clara, enfrentamento de riscos e pedido operacional executável.
...
- revolver prova
- não demonstrar violação legal/constitucional
- fato sem fonte
