...
```json
{
  ...
  "resultado_principal": {
    "fase_1_analise_de_cabimento": {},
    "fase_2_plano_da_peca": {
      "tese_principal": "",
      "teses_subsidiarias": [],
      "provas_usadas": [],
      "riscos": []
    ...
    "fase_3_minuta": "",
    "fase_4_checklist_de_protocolo": {
      "documentos_anexar": [],
      "pedidos_operacionais": [],
      "revisoes_obrigatorias": []
    }
  },
  "achados_criticos": [],
  "achados_secundarios": [],
...
- A via escolhida é cabível?
- Há prova documental mínima?
- Qual é a decisão/ato a atacar ou pedido a formular?
- A minuta terá pedido operacional e subsidiário?
- Há risco de urgência ou prazo?
...
- Antes de redigir, validar cabimento e prova mínima.
- A minuta deve conter pedido principal, pedido subsidiário e pedido operacional.
- Não usar doutrina genérica quando tabela, data ou documento resolverem o ponto.
- Gerar checklist de anexos e revisão humana antes do protocolo.
...
A skill deve redigir recurso especial extraordinario apenas após validar cabimento, documentos e riscos.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["analise_cabimento", "plano_da_peca", "minuta", "pedidos_operacionais", "checklist_protocolo"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    {"skill": "ep-revisor-juridico", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-revisor-probatorio", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-antifalucinacao-juridica", "motivo": "continuidade técnica recomendada"}
  ],
  "revisao_humana_obrigatoria": true
}
```
