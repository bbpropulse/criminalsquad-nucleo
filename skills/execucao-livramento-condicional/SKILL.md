...
**Pressuposto comum a TODAS as hipóteses (art. 83, *caput*):** pena privativa de liberdade **igual ou superior a 2 anos**. Esse piso não é do inciso I — está no *caput* e condiciona também os incisos II e V. Só verificado ele é que se passa à fração.

| Inciso | Fração | Situação |
|--------|--------|----------|
| I | **mais de 1/3** | **não reincidente em crime doloso** e com **bons antecedentes** |
