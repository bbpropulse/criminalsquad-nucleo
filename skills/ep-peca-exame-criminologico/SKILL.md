---
name: ep-peca-exame-criminologico
description: >-
  Use para redigir impugnação de exigência ou laudo de exame criminológico, pedido de complementação
  ou nova avaliação. Não use para decisão final, assinatura, protocolo ou citação não verificada.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-peca-exame-criminologico"]
...
Produzir minuta contra exigência indevida ou laudo criminológico frágil, demonstrando vícios, prova favorável e pedido adequado.

# Quando usar

- Quando o exame foi exigido sem fundamentação.
- Quando laudo é genérico, contraditório ou desatualizado.
- Quando benefício foi indeferido por exame.
- Quando se busca complementação ou nova avaliação.

# Entradas necessárias ou desejáveis

- Decisão que exigiu exame.
- Laudo completo.
- Atestado de conduta.
...
1. Identificar ato impugnado.
2. Demonstrar vício da exigência ou do laudo.
3. Apontar ausência de metodologia, generalidade ou contradição.
4. Contrapor prova favorável atual.
5. Enfrentar gravidade abstrata do crime como fundamento insuficiente, se aplicável.
6. Pedir desconsideração, complementação ou nova avaliação.
7. Pedir análise do benefício com base no conjunto probatório.
8. Formular pedidos subsidiários.
...
```json
{
  "skill": "ep-peca-exame-criminologico",
...
A skill deve produzir impugnação de exame criminológico com padrão de criminalista sênior: objetivo, documentado, com cálculo quando aplicável, tese clara, enfrentamento de riscos e pedido operacional executável.
...
- metodologia
- provas favoráveis
- pedido de desconsideração/complementação
...
- criticar laudo sem apontar vício
- não enfrentar direito intertemporal
- não juntar conduta favorável
- fato sem fonte
