---
name: ep-linha-do-tempo-executoria
description: >-
  Use para criar cronologia estratégica da execução penal com eventos, fontes e impacto jurídico.
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-linha-do-tempo-executoria"]
...
Transformar documentos e eventos em uma linha do tempo útil para cálculo, diagnóstico, peça e sustentação oral.

# Quando usar

- Antes de parecer, peça ou recurso.
- Quando houver vários incidentes e datas relevantes.
- Ao revisar cálculo ou benefício.
- Ao explicar o caso ao cliente ou ao julgador.

# Entradas necessárias ou desejáveis

- Dados extraídos do processo.
- Eventos do SEEU ou sistema processual.
- Documentos classificados.
- Datas indicadas pela família ou cliente, separadas das datas documentadas.

# Protocolo obrigatório

1. Reunir eventos em ordem cronológica.
2. Classificar cada evento por tipo: condenação, prisão, cálculo, benefício, falta, remição, decisão, recurso, saúde, transferência ou alvará.
3. Indicar fonte documental de cada evento.
4. Identificar impacto de cada evento no cálculo, data-base, regime, benefício ou risco.
5. Destacar eventos controversos ou sem prova suficiente.
6. Criar versão sintética e versão completa.
7. Indicar lacunas temporais importantes.
8. Entregar linha do tempo pronta para uso em peça.
...
```json
{
  "skill": "ep-linha-do-tempo-executoria",
...
- A cronologia deve tornar visível o caminho da execução e o ponto de ilegalidade ou oportunidade.
...
Linha do tempo é ferramenta de persuasão e cálculo. A skill deve mostrar evolução da execução e destacar o evento que gera ilegalidade ou oportunidade.

## Perguntas críticas que a skill deve responder

- Qual foi o primeiro marco relevante?
- Quando começou a prisão computável?
- Quando houve trânsito?
- Quando foi expedida a guia?
- Quando mudou a data-base?
- Quando houve falta/remição/progressão?
- Qual evento gerou atraso?
- Qual benefício venceu em qual data?
- Há lacuna documental?
- Qual marco deve aparecer na peça?
...
4. atribuir fonte
5. detectar lacunas
6. criar versão completa
7. criar versão sintética para peça
8. destacar marcos críticos

## Armadilhas e erros de alta gravidade

- ordem cronológica errada
- data sem fonte
- evento administrativo tratado como decisão
- omissão de falta grave ou remição
