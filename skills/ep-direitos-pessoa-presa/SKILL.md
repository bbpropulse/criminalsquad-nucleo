---
name: ep-direitos-pessoa-presa
description: >-
  Use para analisar violações de direitos da pessoa presa e convertê-las em pedidos concretos. Não
  use para conclusão definitiva sem autos suficientes, fonte atual ou revisão profissional.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-direitos-pessoa-presa"]
...
Transformar relatos e documentos sobre violações carcerárias em análise jurídica, matriz probatória e providência operacional.

# Quando usar

- Quando houver relato de saúde, alimentação, higiene, visita, trabalho, estudo, tortura, ameaça, isolamento ou transferência.
- Quando a pessoa presa sofre restrição não explicada.
- Quando se pretende formular pedido de providências.

# Entradas necessárias ou desejáveis

- Relato do preso/família.
- Documentos médicos, fotos, declarações ou ofícios.
- Resposta da unidade, se houver.
- Histórico de pedidos administrativos.
- Dados da unidade e regime.

# Protocolo obrigatório

1. Classificar o tipo de violação.
2. Separar relato de prova documental.
3. Identificar urgência e risco concreto.
4. Verificar se há pedido administrativo prévio ou necessidade de tutela judicial imediata.
5. Listar provas necessárias.
6. Identificar órgãos ou autoridades a comunicar, se útil.
7. Formular providência operacional: atendimento, ofício, inspeção, transferência, restabelecimento de visita ou proteção.
8. Indicar instrumento adequado.
9. Entregar matriz de violação e pedido recomendado.
...
```json
{
  "skill": "ep-direitos-pessoa-presa",
...
- A análise deve ser concreta e evitar invocação abstrata de dignidade sem pedido operacional.
...
A skill deve converter violação em providência específica e executável. Não basta dizer que há violação de dignidade: é preciso indicar prova, urgência, destinatário e ato judicial/administrativo.
...
- Há risco atual?
- Qual prova existe?
- A unidade foi provocada?
- Há urgência médica ou física?
- Qual órgão deve ser comunicado?
- Qual providência resolve?
- Há necessidade de sigilo?
- Há grupo vulnerável?
- Cabe pedido judicial ou administrativo?

## Documentos e dados específicos a procurar

- relatos
- prontuário/laudo/receita
- fotos
- declarações
...
1. Classificar violação
2. medir urgência
3. identificar prova
4. solicitar prova faltante
5. definir providência
6. definir órgãos
7. proteger sigilo
8. gerar pedido
...
- risco de morte sem urgência
- tortura tratada como mero pedido administrativo
- dados sensíveis expostos
- pedido genérico sem prazo ou ofício
