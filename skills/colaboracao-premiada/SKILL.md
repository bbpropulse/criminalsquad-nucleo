...
- **Regra de corroboração (art. 4º, §16):** "nenhuma das seguintes medidas será decretada ou proferida com fundamento apenas nas declarações de colaborador" — e o rol é fechado em três incisos: **I** medidas cautelares reais ou pessoais; **II** recebimento de denúncia ou queixa-crime; **III** sentença condenatória. ⚠️ **Não acrescente a pronúncia ao rol** sem conferir a redação vigente: a decisão de pronúncia não está entre os incisos, e ampliar a lista de cabeça entrega ao MP a resposta pronta. Sustente a pronúncia por outra via (juízo de admissibilidade e standard probatório), não como se o §16 a nomeasse. Exige-se **lastro externo** (provas de corroboração). Essa é a principal blindagem do delatado — e tese central da defesa de quem é apontado por delator.
...
| **Não oferecimento de denúncia** (espécie de imunidade) | art. 4º, §4º e §4º-A | requisitos **cumulativos**: (a) a proposta referir-se a **infração de cuja existência o MP não tenha prévio conhecimento** — e o §4º-A considera **existente** o conhecimento prévio quando já instaurado inquérito ou procedimento investigatório para apurar os fatos apresentados; (b) o colaborador **não for o líder** da organização (inc. I); (c) for o **primeiro** a prestar efetiva colaboração (inc. II) |

> ⚠️ **O requisito que mais derruba a imunidade é o primeiro, e é o que costuma ser esquecido.** Se já existe inquérito ou procedimento investigatório sobre os fatos que o cliente pretende entregar, o §4º-A afasta o benefício. Prometer imunidade sem checar isso faz o cliente confessar, renunciar ao silêncio (art. 4º, §14) e entregar anexos contra uma contrapartida legalmente inviável — a posição defensiva é destruída e nada se recebe em troca. **Confira o §4º e o §4º-A na fonte oficial antes de levar a proposta ao cliente.**
...
1. **Voluntariedade** (art. 4º, *caput*, e §7º, **IV**): manifestação **livre**, sem coação, sem promessa indevida, sem indução. Voluntário ≠ espontâneo — pode ser provocado por proposta, mas a adesão tem de ser livre. Colaboração obtida sob pressão (ex.: para cessar prisão ilegal) é viciada — e o **§7º, IV** é a âncora textual exata desse argumento, porque manda o juiz analisar a voluntariedade "especialmente nos casos em que o colaborador **está ou esteve sob efeito de medidas cautelares**". O inciso **I** cuida de outra coisa (regularidade e legalidade); citá-lo aqui perde justamente o inciso que menciona o colaborador cautelarmente constrito.
...
4. REMESSA AO JUIZ (art. 4º, §7º)  — o prazo de 48h da lei NAO e de distribuicao:
   o art. 7º, §1º manda que o juiz a quem recair a distribuicao DECIDA em 48h.
...
CLÁUSULA 3ª — DOS BENEFÍCIOS (art. 4º, caput, §§2º, 4º e 5º)
  ...
  (art. 4º, §4º e §4º-A — infração sem prévio conhecimento do MP, colaborador
   não líder e primeiro a colaborar);
