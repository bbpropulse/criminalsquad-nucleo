---
name: ep-penas-restritivas-direitos
description: >-
  Analisa execução de penas restritivas de direitos, descumprimento, justificação, adequação e
  conversão. Não use para conclusão definitiva sem autos suficientes, fonte atual ou revisão
  profissional.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-penas-restritivas-direitos"]
...
Executar a competência especializada `ep-penas-restritivas-direitos` em execução penal brasileira, com foco em prova, cálculo quando aplicável, risco, providência concreta e revisão humana.

# Quando usar

- Quando a tarefa envolver analisa execução de penas restritivas de direitos, descumprimento, justificação, adequação e conversão.
