...
```json
{
  "skill": "ep-penas-restritivas-direitos",
  "case_id": "",
  "task_id": "",
  "modo": "parecer_interno|minuta_protocolavel|checklist|resumo_cliente|saida_estruturada",
...
- Qual pena restritiva foi imposta?
- Houve audiência admonitória?
- O descumprimento foi justificado?
- Houve intimação regular?
- Cabe adequação ou conversão?
...
Prestação de serviços descumprida por doença ou trabalho; a skill deve recomendar justificação e readequação antes de conversão.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["tipo_restritiva", "status_cumprimento", "descumprimento", "justificativa", "risco_conversao", "pedido"]
  },
  "achados_criticos": [
