---
name: ep-memoriais-sustentacao-oral
description: >-
  Use para transformar caso ou recurso em memoriais e roteiro de sustentação oral de 3, 5 ou 10
  minutos. Não use para decisão final, assinatura, protocolo ou citação não verificada.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-memoriais-sustentacao-oral"]
...
Converter tese de execução penal em comunicação oral ou memorial persuasivo, objetivo, cronológico e orientado ao pedido.

# Quando usar

- Antes de julgamento de agravo, HC, MS ou recurso.
- Quando o advogado precisa despachar memoriais.
- Quando a tese é complexa e precisa de simplificação oral.
- Quando é necessário antecipar objeções do MP.
...
- Linha do tempo.
- Tese central.
- Cálculo ou prova essencial.
- Tempo disponível para fala.
- Perfil do tribunal, se conhecido.

# Protocolo obrigatório

1. Identificar tese central em uma frase.
2. Selecionar três fatos decisivos.
3. Selecionar prova ou cálculo decisivo.
4. Construir abertura clara.
5. Preparar roteiro de 3, 5 e 10 minutos.
6. Preparar resposta às objeções prováveis.
7. Preparar pedido final objetivo.
8. Criar versão de memoriais escritos, se solicitado.
9. Evitar excesso de doutrina e focar ilegalidade concreta.
10. Listar pontos de revisão humana.
...
```json
{
  "skill": "ep-memoriais-sustentacao-oral",
...
- A sustentação deve ser simples, cronológica e focada no ponto que muda o resultado.
...
A skill deve produzir memoriais e sustentação oral com padrão de criminalista sênior: objetivo, documentado, com cálculo quando aplicável, tese clara, enfrentamento de riscos e pedido operacional executável.
