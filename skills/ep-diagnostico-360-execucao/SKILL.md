---
name: ep-diagnostico-360-execucao
description: >-
  Use para produzir diagnóstico completo de execução penal, identificando situação atual,
  oportunidades, riscos, urgências e estratégia. Não use para conclusão definitiva sem autos
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-diagnostico-360-execucao"]
...
Entregar uma visão 360º da execução penal sem redigir peça: situação, cálculo, benefícios, incidentes, direitos violados, riscos e providências.

# Quando usar

- Após extração de dados e linha do tempo.
- Ao revisar caso novo com processo completo.
- Antes de definir estratégia.
- Ao auditar carteira.

# Entradas necessárias ou desejáveis

- Dados executórios estruturados.
- Linha do tempo.
- Cálculo ou dados para cálculo.
- Certidões, PADs, remições, decisões e relatórios.
- Objetivo do advogado.

# Protocolo obrigatório

1. Resumir situação atual da execução.
2. Verificar consistência mínima do cálculo.
3. Identificar benefícios possíveis ou vencidos.
4. Identificar incidentes que afetam mérito ou data-base.
5. Identificar direitos violados e urgências.
6. Apontar documentos faltantes.
7. Sugerir estratégia principal e alternativas.
8. Classificar prioridade e risco.
9. Indicar peça ou providência recomendada.
10. Entregar relatório executivo.
...
- O diagnóstico deve ser suficiente para reunião estratégica interna.
...
Esta skill entrega visão completa sem redigir peça. Deve ser usada para decidir estratégia geral, priorizar providências e identificar riscos ocultos.

## Perguntas críticas que a skill deve responder

- Qual é a situação atual?
- Qual é o maior ganho jurídico possível?
- Qual é o maior risco?
- Há cálculo confiável?
- Há benefício vencido?
- Há incidente disciplinar?
- Há violação de direitos?
- Qual peça é prioritária?
- Qual documento falta?
- Qual é o plano em 24h, 7 dias e 30 dias?

## Documentos e dados específicos a procurar

- processo inteiro ou conjunto classificado
- cálculo
- linha do tempo
- documentos de conduta/remição/PAD

## Protocolo ampliado de alta performance

1. Consolidar dados
2. auditar superficialmente riscos
3. identificar oportunidades
4. priorizar urgências
5. mapear documentos faltantes
6. definir estratégia principal
7. definir alternativas
8. entregar plano de ação

## Armadilhas e erros de alta gravidade

- parecer longo sem ação
- ignorar alvará ou término
- ignorar direito urgente
- misturar diagnóstico com minuta sem prova
