...
> ⚠️ **O exculpante não tem dispositivo — não cole o art. 23 nele.** O parágrafo único do art. 23 do CP trata só do excesso **punível**: "o agente responderá pelo excesso doloso ou culposo". O excesso exculpante é **construção doutrinária** (inexigibilidade de conduta diversa), sem previsão expressa no Código. Sustente-o **como tese**, com a base fática do medo/perturbação — jamais anunciado como texto de lei ao lado de uma citação de artigo. No plenário ele é votado pelo **quesito genérico de absolvição** (art. 483, §2º), que não exige fundamento nomeado; é exatamente por isso que a tese funciona sem dispositivo próprio.
