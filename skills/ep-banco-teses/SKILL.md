...
name: ep-banco-teses
description: >-
  Use para cadastrar, organizar ou recuperar teses de execução penal com fundamentos, precedentes,
  riscos e modelos de argumento. Não use para conclusão definitiva sem autos suficientes, fonte
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-banco-teses"]
...
Transformar conhecimento jurídico do escritório em banco de teses reutilizável, versionável e revisável.

# Quando usar

- Ao criar tese nova.
- Ao revisar tese existente.
- Ao preparar peça com argumento recorrente.
- Ao atualizar jurisprudência ou lei.

# Entradas necessárias ou desejáveis

- Tema da tese.
- Situação fática de aplicação.
- Fundamentos legais.
...
1. Identificar tema e subtema.
2. Definir quando usar e quando não usar.
3. Listar elementos fáticos necessários.
4. Listar documentos indispensáveis.
5. Registrar fundamentos normativos a verificar.
6. Registrar precedentes favoráveis e contrários.
7. Criar modelo de argumento adaptável.
8. Classificar risco e tribunal receptivo, se conhecido.
9. Registrar data de atualização e necessidade de revisão futura.
...
- A tese deve ser operacional para peça, não apenas resumo doutrinário.
...
A skill deve transformar banco de teses em rotina de alta performance. O foco é reduzir esquecimento, padronizar qualidade, criar ação e preservar comunicação clara.
