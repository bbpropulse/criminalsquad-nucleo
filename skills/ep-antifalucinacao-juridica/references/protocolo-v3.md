...
- Há dado sem fonte?
- Há precedente sem verificação?
- Há artigo/súmula suspeito?
- Há data calculada sem fórmula?
- Há documento inexistente citado?
...
A skill deve bloquear minuta que cita súmula sem fonte e data de progressão não demonstrada nos documentos.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["aprovado", "bloqueios", "correcoes_obrigatorias", "trechos_perigosos", "nivel_confianca"]
  },
  "achados_criticos": [
