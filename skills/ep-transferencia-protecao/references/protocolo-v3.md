...
- Qual prova existe?
- Há risco atual?
- Qual providência operacional é necessária?
- É necessário sigilo ou comunicação a órgão de controle?
...
A skill deve transformar relato de violação em pedido concreto, com prova e urgência.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["violacao", "urgencia", "provas", "providencia", "sigilo"]
  },
  "achados_criticos": [
