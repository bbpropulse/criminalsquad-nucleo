---
name: ep-transferencia-protecao
description: >-
  Use para analisar transferência por ameaça, facção, tortura, risco, saúde, proximidade familiar ou
  unidade incompatível. Não use para conclusão definitiva sem autos suficientes, fonte atual ou
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-transferencia-protecao"]
...
Avaliar pedido de transferência ou proteção prisional com foco em risco concreto, prova, sigilo, urgência e unidade adequada.

# Quando usar

- Quando há ameaça contra a pessoa presa.
- Quando há risco de tortura ou maus-tratos.
- Quando há conflito de facção ou segurança.
- Quando a família está distante e isso prejudica reintegração/visita.
- Quando unidade não atende condição de saúde ou vulnerabilidade.

# Entradas necessárias ou desejáveis

- Relatos e declarações.
- Boletins, notícias de fato, documentos médicos ou relatórios.
- Histórico de ameaças, agressões ou transferências.
- Dados de unidade atual e unidade pretendida.
- Pedidos administrativos e respostas.

# Protocolo obrigatório

1. Identificar finalidade da transferência: proteção, saúde, família, trabalho/estudo ou adequação de regime.
2. Separar fatos comprovados de relatos sensíveis.
3. Avaliar risco concreto e urgência.
4. Definir nível de sigilo necessário.
5. Indicar prova mínima e documentos a solicitar.
6. Avaliar unidade adequada ou critérios de escolha.
7. Indicar órgãos a comunicar se houver tortura/ameaça grave.
8. Formular pedido principal e subsidiário.
9. Entregar matriz de risco e providência.
...
```json
{
  "skill": "ep-transferencia-protecao",
  "status": "concluido | concluido_com_ressalvas | bloqueado",
  "resultado": {
    "transferencia_protecao": {
      "motivo": "",
      "risco": "alto | medio | baixo",
      "sigilo_recomendado": false,
      "provas": [],
      "provas_faltantes": [],
      "unidade_adequada": "",
      "pedido_recomendado": "",
...
- A resposta deve preservar informações sensíveis e evitar exposição que aumente risco.
...
A skill deve lidar com risco físico, ameaça, facção, tortura, proximidade familiar ou unidade inadequada com sigilo e objetividade.
...
- Quem ameaça?
- Há prova?
- Há histórico de agressão?
- A unidade foi comunicada?
- Há necessidade de sigilo?
- Qual unidade é adequada?
- A transferência piora defesa/família?
- Cabe medida protetiva interna?
- Qual órgão comunicar?
...
1. Classificar motivo
2. medir risco
3. proteger dados sensíveis
4. validar prova
5. definir transferência/proteção
6. definir comunicação a órgãos
7. formular pedido urgente

## Armadilhas e erros de alta gravidade

- expor nome de ameaçador desnecessariamente
- pedido de transferência sem destino ou critério
- ameaça grave tratada sem urgência
- risco de facção em documento público sem sigilo
