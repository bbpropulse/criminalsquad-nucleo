...
```json
{
  "skill": "ep-inspecao-prisional-prova-estrutural",
  "case_id": "",
  "task_id": "",
  "modo": "parecer_interno|minuta_protocolavel|checklist|resumo_cliente|saida_estruturada",
  ...
  "resultado_principal": {
    ...
    "urgencia": {
      "nivel": "imediata|alta|media|baixa",
      "motivo": "",
      "risco_se_nao_agir": ""
    },
    "providencias": [],
...
- Qual violação estrutural é alegada?
- Há prova individual e coletiva?
- Existe inspeção, relatório, fotografia, laudo ou notícia oficial?
- O pedido é individual, coletivo ou estrutural?
...
- Transformar violação em pedido concreto: ofício, prontuário, consulta, transferência, inspeção, audiência ou medida urgente.
- Diferenciar relato, prova médica, prova institucional e risco atual.
- Em dados sensíveis, avaliar sigilo e mínima exposição.
- Quando houver ameaça ou saúde grave, classificar urgência e risco se nada for feito.
...
Superlotação e falta de banho de sol documentadas por relatório; a skill deve criar matriz de prova e pedido de providência/inspeção.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["violacoes", "provas_individuais", "provas_coletivas", "urgencia", "pedido_estrutural", "orgaos"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    {"skill": "ep-peca-saude-transferencia-protecao", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-revisor-probatorio", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-domiciliar-harmonizacao", "motivo": "continuidade técnica recomendada"}
  ],
  "revisao_humana_obrigatoria": true
}
```
