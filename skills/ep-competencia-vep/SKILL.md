---
name: ep-competencia-vep
description: >-
  Analisa competência do juízo da execução, remessa, transferência, conflito de competência e
  efeitos operacionais. Não use para conclusão definitiva sem autos suficientes, fonte atual ou
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-competencia-vep"]
...
Executar a competência especializada `ep-competencia-vep` em execução penal brasileira, com foco em prova, cálculo quando aplicável, risco, providência concreta e revisão humana.

# Quando usar

- Quando a tarefa envolver analisa competência do juízo da execução, remessa, transferência, conflito de competência e efeitos operacionais.
