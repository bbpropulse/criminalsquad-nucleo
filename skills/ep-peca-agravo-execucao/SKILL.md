---
name: ep-peca-agravo-execucao
description: >-
  Use para redigir agravo em execução contra decisão de execução penal, com interposição, razões,
  retratação e pedidos ao tribunal. Não use para decisão final, assinatura, protocolo ou citação não
  verificada.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-peca-agravo-execucao"]
...
Produzir minuta de agravo em execução tecnicamente estruturada, com cabimento, tempestividade, decisão agravada, tese, prejuízo e pedido recursal.

# Quando usar

- Quando houver decisão desfavorável na execução.
- Contra indeferimento de benefício.
- Contra homologação de falta, regressão, cálculo, remição, indulto ou exame.
- Quando a via adequada for agravo.

# Entradas necessárias ou desejáveis

- Decisão agravada.
- Data da intimação.
- Peças obrigatórias ou documentos relevantes.
- Cálculo e provas.
- Tese jurídica.
...
1. Identificar decisão agravada e data de intimação.
2. Verificar cabimento e tempestividade conforme prática local.
3. Redigir peça de interposição.
4. Redigir razões com síntese objetiva.
5. Demonstrar erro da decisão e prejuízo concreto.
6. Usar documentos e cálculo como prova.
7. Inserir jurisprudência aplicável e atualizada.
8. Pedir retratação ao juízo de origem.
9. Pedir provimento ao tribunal.
10. Pedir efeito ativo/suspensivo quando houver urgência.
11. Listar documentos e revisão.
...
A skill deve produzir agravo em execução com padrão de criminalista sênior: objetivo, documentado, com cálculo quando aplicável, tese clara, enfrentamento de riscos e pedido operacional executável.
...
- não juntar decisão agravada
- confundir HC com agravo
- pedido sem efeito prático
- fato sem fonte
