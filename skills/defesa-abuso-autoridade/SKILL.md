...
- **Ética por polo:** esta skill é de **DEFESA** do agente público. Se a atuação for do **Ministério Público** (acusação/assistência) ou da **Defensoria**, observe o regramento próprio (CNMP; LC 80/94) e o conflito de interesses (art. 15, § 6º, EAOAB + CED 19-21).
