---
name: ep-auditoria-calculo-pena
description: >-
  Use para auditar cálculo de pena, data-base, detração, remição, frações, progressão, livramento,
  término e benefícios vencidos. Não use para escolha automática de lei, fração, marco ou
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-auditoria-calculo-pena"]
  ...
  engines: ["fraction-date", "remission", "executory-limitation"]
---
...
Auditar tecnicamente o cálculo de pena com base nos documentos fornecidos, comparando cálculo oficial e cálculo defensivo, indicando premissas, divergências, impacto prático e riscos.

# Quando usar

- Sempre que houver cálculo oficial ou atestado de pena.
- Antes de progressão, livramento, indulto, comutação, extinção ou impugnação.
- Quando houver falta grave, remição, detração, nova condenação ou unificação.
- Quando houver suspeita de excesso de execução.

# Entradas necessárias ou desejáveis

- Sentença e acórdãos.
- Guias de recolhimento.
- Cálculo oficial e atestado de pena a cumprir.
- Certidões de prisão para detração.
- Certificados e decisões de remição.
- Decisões de falta grave, progressão, regressão, comutação ou indulto.
- Dados sobre novas condenações e unificação.

# Protocolo obrigatório

1. Identificar todas as condenações e penas individualizadas.
2. Extrair data do fato, natureza do crime e regime de cada condenação.
3. Identificar data de prisão, soltura, detração e períodos computáveis.
4. Identificar data-base oficial e verificar sua origem.
5. Identificar faltas graves e seus efeitos no benefício analisado.
6. Identificar remições homologadas e pendentes.
7. Aplicar frações de progressão e livramento conforme premissas documentadas e direito intertemporal.
8. Calcular datas prováveis de progressão, livramento e término.
9. Gerar cenários alternativos quando a tese jurídica for controvertida.
10. Comparar cálculo oficial e cálculo defensivo.
11. Apontar divergências e impacto em dias.
12. Indicar benefícios vencidos, se houver base segura.
13. Listar documentos faltantes e pontos para revisão humana.
...
- Não aplicar fração sem identificar a premissa jurídica e a data do fato.
- Não descontar remição sem documento ou decisão correspondente.
- Não alterar data-base por falta grave sem verificar a validade mínima do PAD/homologação.
...
- Toda data calculada deve ter fórmula ou premissas transparentes.
- A saída deve permitir transformar divergência em impugnação de cálculo.
...
Esta é a skill nuclear da execução penal. Deve auditar o cálculo oficial com independência, demonstrando cada premissa, cada data e cada impacto. Não basta dizer que o cálculo está certo ou errado; é necessário mostrar onde, por quê e qual providência corrige.

## Perguntas críticas que a skill deve responder

- Qual é a pena total por condenação?
- Qual período de prisão deve ser detraído?
- A data-base oficial tem origem documentada?
- Há falta grave válida e qual efeito ela tem?
- Há remição homologada e remição pendente?
- A fração aplicada corresponde à data do fato e natureza do crime?
- Há nova condenação/unificação?
- Qual data de progressão?
- Qual data de livramento?
- Qual término de pena?
- Qual divergência em dias contra o cálculo oficial?
...
- certificados e decisões de remição
- decisões de progressão/regressão/comutação

## Protocolo ampliado de alta performance

1. Separar condenações
2. converter penas
3. identificar marcos de prisão
4. calcular detração
5. validar data-base
6. validar faltas
7. validar remições
8. definir frações por cenário
9. calcular progressão
10. calcular livramento
11. calcular término
12. comparar com oficial
13. listar divergências
14. indicar peça cabível

## Armadilhas e erros de alta gravidade

- data-base sem origem
- remição pendente abatida como homologada
- fração errada por ignorar data do fato
- falta grave inválida alterando cálculo
- prisão cautelar não detraída
- nova condenação ignorada
