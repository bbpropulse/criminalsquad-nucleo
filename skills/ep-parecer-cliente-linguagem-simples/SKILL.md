---
name: ep-parecer-cliente-linguagem-simples
description: >-
  Use para explicar situação da execução penal ao cliente ou família em linguagem simples, sem
  promessa de resultado. Não use para compartilhamento de dados, promessa de resultado ou decisão
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-parecer-cliente-linguagem-simples"]
...
Converter análise técnica em comunicação clara, honesta e compreensível para cliente/família, indicando situação, riscos, próximos passos e documentos necessários.

# Quando usar

- Após diagnóstico ou análise de benefício.
- Para enviar atualização ao cliente/família.
- Quando o tema técnico precisa ser explicado sem juridiquês.
- Quando é necessário alinhar expectativas.
...
- Cálculo resumido.
- Próximo benefício.
- Riscos e documentos faltantes.
- Plano de atuação.

# Protocolo obrigatório

1. Resumir situação atual em linguagem simples.
2. Explicar próximo benefício ou providência.
3. Indicar data provável apenas se calculada e com ressalva.
4. Explicar documentos faltantes e quem pode providenciar.
5. Explicar riscos sem alarmismo.
6. Indicar próximos passos do escritório.
7. Evitar promessa de resultado.
8. Evitar termos técnicos sem explicação.
9. Entregar mensagem pronta para cliente.
...
```json
{
  "skill": "ep-parecer-cliente-linguagem-simples",
...
- Não prometer soltura, progressão, prazo de decisão ou resultado judicial.
...
- A comunicação deve reduzir ansiedade sem criar expectativa falsa.
...
A skill deve transformar parecer simples para cliente/família em rotina de alta performance. O foco é reduzir esquecimento, padronizar qualidade, criar ação e preservar comunicação clara.
