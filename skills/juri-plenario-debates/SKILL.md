...
|---|---|---|---|
| **Regra geral** | 1h30 | 1h30 | 1h (réplica) + 1h (tréplica) |
| **Mais de um ACUSADO** (§2º) | 2h30 | 2h30 | 2h (réplica) + 2h (tréplica) |

> **Quem multiplica o tempo é o réu, não o orador.** O acréscimo do **§2º** é acionado por **mais de um acusado**. Havendo **mais de um acusador** (MP + assistente) ou **mais de um defensor**, o caso é do **§1º**: eles **combinam entre si a distribuição** do mesmo tempo — que, na falta de acordo, o juiz-presidente divide. Somar tempo porque o assistente se habilitou é erro de cálculo que estoura o cronômetro da própria acusação.
...
- Havendo **mais de um defensor**, o tempo (já acrescido, se houver pluralidade de réus) é **dividido** entre eles: combinam a repartição e, na falta de acordo, quem divide é o juiz-presidente (art. 477, **§1º**).
...
- **Tempo (art. 477):** 1h30 (regra) / 2h30 (**pluralidade de réus**, §2º) + réplica/tréplica de 1h/2h. Mais de um **orador** por lado não acresce nada — **divide** (§1º). **Defesa tem a última palavra.**
