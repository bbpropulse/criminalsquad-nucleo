...
- Há procedimento válido?
- Qual prova existe?
- Qual efeito executório está em disputa?
- Há urgência, nulidade ou medida menos gravosa?
...
A skill deve identificar vícios, efeitos e instrumento de reação em situação de crise.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["incidente", "validade", "nulidades", "efeitos", "estrategia", "urgencia"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    ...
    {"skill": "ep-peca-agravo-execucao", "motivo": "continuidade técnica recomendada"}
  ],
  "revisao_humana_obrigatoria": true
}
```
