---
name: ep-revisor-probatorio
description: >-
  Use para revisar se cada afirmação da peça está amparada por documento, fonte ou prova suficiente.
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-revisor-probatorio"]
...
Garantir que a peça ou parecer esteja documentalmente suportado, identificando alegações sem prova, prova insuficiente e documentos essenciais ausentes.

# Quando usar

- Antes de protocolo.
- Quando a peça contém muitos fatos e datas.
- Quando há alegações de saúde, remição, falta grave ou excesso.
- Quando documentos foram citados sem conferência.

# Entradas necessárias ou desejáveis

- Minuta ou parecer.
- Documentos citados.
- Matriz de prova, se houver.
- Lista de anexos.

# Protocolo obrigatório

1. Extrair afirmações fáticas relevantes.
2. Associar cada afirmação a documento específico.
3. Verificar suficiência da prova.
4. Identificar prova ausente, contraditória ou fraca.
5. Sugerir ajuste de linguagem para alegações parcialmente comprovadas.
6. Listar documentos indispensáveis que devem ser anexados.
7. Bloquear protocolo quando prova crítica estiver ausente.
8. Entregar matriz probatória revisada.
...
- A revisão deve proteger a credibilidade da peça.
...
A skill executa revisão probatória. Seu papel é impedir protocolo de material fraco, perigoso ou contraditório. Deve apontar problemas com franqueza e classificar gravidade.
