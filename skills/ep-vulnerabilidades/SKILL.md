---
name: ep-vulnerabilidades
description: >-
  Use para identificar vulnerabilidades na execução penal: mulher, gestante, lactante, idoso,
  deficiência, LGBTQIA+, indígena, migrante, doença grave ou ameaça. Não use para conclusão
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-vulnerabilidades"]
...
Individualizar análise e pedidos conforme vulnerabilidades da pessoa executada, conectando condição pessoal, risco concreto, prova e providência.

# Quando usar

- Quando houver pessoa em grupo vulnerável.
- Quando a condição pessoal pode justificar domiciliar, transferência, saúde, proteção ou adaptação.
- Quando o pedido precisa ser individualizado.

# Entradas necessárias ou desejáveis

- Dados pessoais e sociais.
- Laudos, certidões, documentos familiares, documentos de identidade ou pertencimento.
- Relatos de risco ou discriminação.
- Dados da unidade prisional.
- Histórico médico, psicológico ou social.

# Protocolo obrigatório

1. Identificar vulnerabilidades documentadas e relatadas.
2. Separar condição pessoal de risco concreto.
3. Verificar documentos necessários para cada vulnerabilidade.
4. Mapear normas e precedentes específicos a verificar.
5. Relacionar vulnerabilidade a providência concreta: domiciliar, saúde, transferência, adaptação, proteção, visita ou tratamento.
6. Avaliar urgência.
7. Indicar linguagem adequada e não estigmatizante.
8. Entregar matriz de vulnerabilidade.
...
```json
{
  "skill": "ep-vulnerabilidades",
  "status": "concluido | concluido_com_ressalvas | bloqueado",
  "resultado": {
    "vulnerabilidades": [
      {
        "tipo": "",
        "status_prova": "comprovada | parcial | relatada",
        "risco_concreto": "",
        "provas_necessarias": [],
...
- A skill deve evitar tokenismo: vulnerabilidade deve gerar pedido concreto e prova.
...
A skill deve identificar condições pessoais que mudam a forma de execução e os pedidos cabíveis, sem reduzir a pessoa à vulnerabilidade.

## Perguntas críticas que a skill deve responder

- Há gestação, lactância ou filhos pequenos?
- Há idade avançada?
- Há deficiência?
- Há doença grave?
- Há transtorno mental?
- A pessoa é indígena, migrante ou estrangeira?
- Há vulnerabilidade LGBTQIA+?
- Há ameaça específica?
- Quais normas específicas se aplicam?
- Qual pedido individualizado?

## Documentos e dados específicos a procurar

- documentos médicos
- certidão de nascimento de filhos
- documentos de deficiência
- relatórios sociais
- documentos consulares
- declarações familiares
- laudos
...
2. confirmar prova
3. mapear risco concreto
4. verificar norma específica
5. definir pedido
6. avaliar sigilo
7. indicar documentos faltantes

## Armadilhas e erros de alta gravidade

- pedido genérico de vulnerabilidade
- exposição de dados íntimos sem necessidade
- sem prova documental
- ignorar interseccionalidade
