...
- **Ética por polo — advocacia:** a atuação do assistente rege-se pelo **Estatuto da OAB, pelo Código de Ética e Disciplina** e pelo **Provimento 205/2021** (publicidade). Verifique **conflito de interesses** (art. 15, § 6º, EAOAB + CED 19-21) na triagem. *(Se a instituição for Ministério Público, aplicam-se as normas do CNMP; se Defensoria, a LC 80/94 — mas esta skill pressupõe atuação como assistente/advogado do ofendido.)*
