...
- **Art. 4º, §4º e §4º-A** — **não oferecimento de denúncia** (imunidade): o **MP poderá deixar de oferecer denúncia** se a proposta se referir a **infração de cuja existência ele não tenha prévio conhecimento** **e** o colaborador **(I) não for o líder** da organização criminosa **e (II) for o primeiro** a prestar efetiva colaboração. São **três** requisitos cumulativos, não dois — e o primeiro é o que mais derruba o benefício: o **§4º-A** considera **existente** o conhecimento prévio quando já instaurado inquérito ou procedimento investigatório para apurar os fatos que o colaborador apresenta. **Cheque isso antes de prometer imunidade ao cliente.**
...
Antes de sentar à mesa: em **coautoria**, um mesmo advogado negociando por dois corréus cujas versões colidem — sobretudo quando **um delata o outro** — é conflito de interesses (art. 15, § 6º, EAOAB + CED 19-21). **Cada colaborador precisa de defesa própria e independente.** Confirme também que a colaboração é a via certa (via `estrategia-plea-negociacao-integrada-anpp-colaboracao`) antes de gastar a moeda aqui.
...
|---|---|---|
| **Não oferecimento de denúncia** (§4º e §4º-A) — imunidade | Infração **sem prévio conhecimento do MP** **+** colaborador **não é líder** **e é o primeiro** a colaborar efetivamente | Os três requisitos são cumulativos; inquérito já instaurado sobre os fatos afasta o benefício (§4º-A) |
...
- **Um só advogado para corréus com versões colidentes** em delação (art. 15, § 6º, EAOAB + CED 19-21).
