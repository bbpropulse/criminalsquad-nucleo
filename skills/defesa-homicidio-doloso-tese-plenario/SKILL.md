...
Reconhece a autoria, mas nega o crime: **agressão injusta, atual ou iminente**, repelida com **meios necessários** e **moderação**. Atenção ao **excesso** (art. 23, parágrafo único): o dispositivo diz que o agente **responderá pelo excesso doloso ou culposo** — ele não perdoa nenhum dos dois. Doloso mantém a responsabilidade a título de **dolo**; culposo leva à responsabilização por crime **culposo** (no júri, caminho da desclassificação). O chamado excesso **exculpante** (medo, susto, perturbação de ânimo) **não está no art. 23**: é construção **doutrinária** de inexigibilidade de conduta diversa e **não pode ser sustentado como texto de lei** — apresente-o como tese, nunca com o parágrafo único colado ao lado. No plenário, a legítima defesa pode ser reconhecida **pelo quesito genérico de absolvição** ("O jurado absolve o acusado?", art. 483, §2º) — a defesa não precisa "provar" a excludente, basta gerar dúvida.
