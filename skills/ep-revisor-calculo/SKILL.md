---
name: ep-revisor-calculo
description: >-
  Use para revisar cálculos, datas, frações, data-base, detração, remição, término e coerência
  matemática da peça. Não use para escolha automática de lei, fração, marco ou consequência
  jurídica.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-revisor-calculo"]
...
Auditar exclusivamente números, datas e premissas de cálculo usados em análise ou peça, detectando inconsistências antes de protocolo.

# Quando usar

- Antes de protocolar qualquer peça com cálculo.
- Ao revisar impugnação de cálculo.
- Quando há divergência entre texto e tabela.
- Quando remição ou detração altera datas.
...
- Cálculo defensivo.
- Cálculo oficial.
- Documentos de remição/detração/falta.
- Linha do tempo.

# Protocolo obrigatório

1. Extrair todas as datas e números da minuta.
2. Comparar com cálculo defensivo e documentos.
3. Verificar frações aplicadas.
4. Verificar data-base usada em cada benefício.
5. Verificar somas e subtrações de pena.
6. Verificar remição e detração.
7. Verificar se texto, tabela e pedidos usam as mesmas datas.
8. Apontar erro crítico, erro menor ou inconsistência.
9. Sugerir correção.
10. Classificar status.
...
- Bloquear se a data do benefício no texto divergir da tabela sem explicação.
- Bloquear se cálculo não indicar premissas.
...
- A revisão deve ser matemática e documental, não retórica.
...
A skill executa revisão de cálculo. Seu papel é impedir protocolo de material fraco, perigoso ou contraditório. Deve apontar problemas com franqueza e classificar gravidade.
