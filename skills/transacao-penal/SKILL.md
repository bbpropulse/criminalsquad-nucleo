...
Aceita a proposta pelo autor do fato e por seu defensor, ela é submetida ao juiz (art. 76, §3º), que, acolhendo-a, aplica **de imediato** a pena **restritiva de direitos** ou **multa** (art. 76, §4º). ⚠️ **Quem especifica a sanção é o MINISTÉRIO PÚBLICO, na proposta** — o *caput* fala em "aplicação imediata de pena restritiva de direitos ou multas, **a ser especificada na proposta**". O juiz não escolhe a pena depois: ele aplica a que foi proposta e aceita. Proposta sem sanção especificada é proposta incompleta, e aceitar às cegas é privar o cliente do objeto do próprio acordo. Pontos de controle:
