...
```json
{
  "skill": "ep-prescricao-executoria",
  "case_id": "",
  "task_id": "",
  "modo": "parecer_interno|minuta_protocolavel|checklist|resumo_cliente|saida_estruturada",
...
- Qual pena concreta ou remanescente?
- Qual marco inicial?
- Houve interrupção ou suspensão?
- Há fuga ou recaptura?
- Há reincidência que altere prazo?
- Cabe pedido de extinção?
...
Condenado permaneceu sem início de cumprimento após trânsito; a skill deve calcular cenário de prescrição e listar marcos que precisam de prova.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["pena_base", "marco_inicial", "marcos_interruptivos", "prazo_prescricional", "data_prescricao", "riscos", "pedido"]
  },
  "achados_criticos": [
