---
name: ep-prescricao-executoria
description: >-
  Analisa prescrição executória, marcos, interrupções, suspensão, fuga, reincidência, pena
  remanescente e pedido de extinção. Não use para escolha automática de lei, fração, marco ou
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-prescricao-executoria"]
...
Executar a competência especializada `ep-prescricao-executoria` em execução penal brasileira, com foco em prova, cálculo quando aplicável, risco, providência concreta e revisão humana.

# Quando usar

- Quando a tarefa envolver analisa prescrição executória, marcos, interrupções, suspensão, fuga, reincidência, pena remanescente e pedido de extinção.
