...
- O requisito objetivo está cumprido?
- Há prova subjetiva atual?
- Há falta grave válida?
- Exame criminológico é exigível nesse caso?
- Há vaga no regime adequado?
- Cabe pedido subsidiário?
...
Lapso objetivo vencido, atestado de conduta favorável e exame criminológico pendente; a skill deve recomendar pedido principal e alternativa contra demora.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["cabimento", "data_lapso", "requisito_objetivo", "requisito_subjetivo", "riscos", "pedido_principal", "pedido_subsidiario"]
  },
  "achados_criticos": [
