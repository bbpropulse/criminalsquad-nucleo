...
- Qual evento originou a data-base?
- A falta grave foi válida e homologada?
- O benefício analisado sofre interrupção por esse evento?
- Há nova condenação ou unificação?
- Há data-base diferente para benefícios distintos?
...
A VEP alterou data-base por falta grave; a skill deve separar efeito para progressão, livramento, indulto/comutação e remição.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["data_base_oficial", "evento_gerador", "data_base_defensiva", "efeitos_por_beneficio", "fundamento", "riscos"]
  },
  "achados_criticos": [
