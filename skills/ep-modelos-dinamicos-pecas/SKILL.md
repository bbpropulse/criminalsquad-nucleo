---
name: ep-modelos-dinamicos-pecas
description: >-
  Use para criar ou revisar modelos dinâmicos de peças de execução penal com campos variáveis e
  blocos condicionais. Não use para decisão final, assinatura, protocolo ou citação não verificada.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-modelos-dinamicos-pecas"]
...
Gerar templates de peças reutilizáveis, com campos obrigatórios, blocos condicionais, documentos necessários e alertas de revisão.

# Quando usar

- Ao criar modelo de peça.
- Ao padronizar escritório.
- Ao transformar peça boa em template.
- Quando o sistema precisa gerar documentos com campos variáveis.

# Entradas necessárias ou desejáveis

- Tipo de peça.
- Peça modelo ou estrutura desejada.
- Campos variáveis.
- Blocos condicionais.
- Regras internas de estilo.

# Protocolo obrigatório

1. Identificar finalidade da peça.
2. Definir campos obrigatórios.
3. Definir campos opcionais.
4. Criar blocos condicionais para falta grave, exame, remição, urgência, regime, prova e pedido subsidiário.
5. Inserir alertas de documentos necessários.
6. Inserir notas de revisão humana.
7. Evitar texto que prometa resultado ou presuma fato.
8. Gerar template em markdown ou texto com placeholders.
9. Listar variáveis e validações.
...
```json
{
  "skill": "ep-modelos-dinamicos-pecas",
...
- O modelo deve ser flexível e reduzir risco de cópia inadequada.
...
A skill deve transformar modelos dinâmicos de peças em rotina de alta performance. O foco é reduzir esquecimento, padronizar qualidade, criar ação e preservar comunicação clara.
