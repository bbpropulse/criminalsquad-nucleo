...
- Qual é a tarefa?
- Quais fatos estão provados?
- Quais premissas são necessárias?
- Qual risco existe?
- Qual próxima ação é útil?
...
- Separar dados de processos/clientes.
- Não expor dados médicos, familiares, crianças, ameaça/facção além do necessário.
- Criar métricas de acurácia, retrabalho, alucinação bloqueada e tempo economizado.
...
A skill deve organizar raciocínio e impedir conclusão sem prova.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["premissas", "fatos", "teses", "riscos", "proximas_acoes"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    ...
    {"skill": "ep-eval-qualidade-skills", "motivo": "continuidade técnica recomendada"},
