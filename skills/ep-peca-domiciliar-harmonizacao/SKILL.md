---
name: ep-peca-domiciliar-harmonizacao
description: >-
  Use para redigir pedido de prisão domiciliar, regime harmonizado ou adequação de regime por falta
  de vaga, saúde, vulnerabilidade ou excesso. Não use para decisão final, assinatura, protocolo ou
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-peca-domiciliar-harmonizacao"]
...
Produzir minuta de pedido de domiciliar/harmonização demonstrando regime devido, regime real, excesso ou condição pessoal, e providência operacional.

# Quando usar

- Quando a análise indicou regime mais gravoso.
- Quando há falta de vaga.
- Quando há saúde, idade, maternidade, deficiência ou vulnerabilidade.
- Quando a pessoa precisa de adequação de regime.

# Entradas necessárias ou desejáveis

- Análise de domiciliar/harmonização.
- Decisão de progressão/regime.
- Certidão de vaga ou documentos da unidade.
- Comprovante de residência.
- Laudos ou documentos pessoais.
- Relatórios de monitoração.

# Protocolo obrigatório

1. Apresentar situação executória.
2. Comparar regime devido e regime efetivo.
3. Demonstrar excesso ou condição pessoal.
4. Juntar prova específica.
5. Fundamentar com norma e jurisprudência verificadas.
6. Pedir domiciliar/harmonização/adequação.
7. Sugerir condições proporcionais, se úteis.
8. Pedir expedição de ofícios, instalação de monitoramento ou cumprimento imediato.
9. Formular pedido subsidiário.
10. Listar documentos e revisão.
...
```json
{
  "skill": "ep-peca-domiciliar-harmonizacao",
...
A skill deve produzir pedido de domiciliar ou harmonização com padrão de criminalista sênior: objetivo, documentado, com cálculo quando aplicável, tese clara, enfrentamento de riscos e pedido operacional executável.
...
- regime devido
- regime real
- falta de vaga/condição pessoal
- residência
- condições
...
- sem prova de regime mais gravoso
- sem residência
- não formular pedido subsidiário
- fato sem fonte
