---
name: ep-peca-livramento-condicional
description: >-
  Use para redigir pedido de livramento condicional com requisito objetivo, subjetivo, condições,
  residência e trabalho/suporte. Não use para decisão final, assinatura, protocolo ou citação não
  verificada.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-peca-livramento-condicional"]
...
Produzir minuta de pedido de livramento condicional com cálculo, prova de mérito, plano mínimo de cumprimento e condições adequadas.

# Quando usar

- Quando o parecer indicou cabimento de livramento.
- Quando o lapso está vencido.
- Quando se pretende pedido subsidiário à progressão ou vice-versa.
- Quando há documentos de residência/trabalho.

# Entradas necessárias ou desejáveis

- Análise de livramento.
- Cálculo auditado.
- Atestado de conduta.
- Certidão disciplinar.
- Comprovante de residência.
- Proposta de trabalho ou suporte familiar.
- Documentos de reparação do dano, se aplicável.

# Protocolo obrigatório

1. Apresentar síntese da execução.
2. Demonstrar requisito objetivo.
3. Demonstrar requisito subjetivo.
4. Enfrentar faltas graves e sua relevância concreta.
5. Comprovar residência e plano de reinserção.
6. Sugerir condições realistas.
7. Fundamentar juridicamente.
8. Pedir concessão do livramento.
9. Pedir expedição dos atos necessários e audiência/termo, se aplicável.
...
```json
{
  "skill": "ep-peca-livramento-condicional",
...
A skill deve produzir pedido de livramento condicional com padrão de criminalista sênior: objetivo, documentado, com cálculo quando aplicável, tese clara, enfrentamento de riscos e pedido operacional executável.
