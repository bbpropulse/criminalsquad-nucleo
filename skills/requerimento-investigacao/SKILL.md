...
Calúnia (138), difamação (139), injúria (140) — regra: *"somente se procede mediante queixa"* (**art. 145, caput, CP**), ou seja, **ação privada** (requerimento com base no art. 5º, §5º). **Exceção do próprio *caput*** (art. 145, *caput*, parte final): **injúria real (140, §2º) de que resulta lesão corporal** — aí a ação deixa de ser privada e passa a ser **pública**. ⚠️ Essa hipótese **não** está no parágrafo único; atribuí-la a ele é erro de remissão frequente. Observe ainda o art. 88 da Lei 9.099/95 quanto à lesão de que se trate.

**Exceções do parágrafo único** (art. 145, p.ú.):
