---
name: ep-triagem-inicial-execucao
description: >-
  Use para fazer a primeira triagem de uma execução penal e identificar urgência, regime, pena,
  riscos e documentos faltantes. Não use para conclusão de mérito sem validação, alteração do
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-triagem-inicial-execucao"]
...
Realizar leitura inicial de um caso de execução penal para definir situação atual, urgência, documentos faltantes, riscos e oportunidades imediatas.

# Quando usar

- Ao receber caso novo.
- Antes de acessar processo completo.
- Quando a família apresenta informações soltas.
- Ao decidir se há urgência jurídica.

# Entradas necessárias ou desejáveis

- Nome ou identificação da pessoa executada.
- Número do processo, se houver.
- Unidade prisional e regime informado.
- Data da prisão e pena informada.
- Relatos sobre faltas, saúde, trabalho, estudo ou benefício indeferido.
- Documentos já disponíveis.

# Protocolo obrigatório

1. Identificar dados mínimos do caso.
2. Separar informações confirmadas de informações apenas relatadas.
3. Classificar urgência em alta, média ou baixa.
4. Verificar sinais de benefício vencido, prisão indevida, saúde urgente, regressão, PAD ou cálculo duvidoso.
5. Listar documentos imprescindíveis para continuar.
6. Indicar primeiras providências.
7. Definir se o caso demanda análise de cálculo, PAD, benefício, direito urgente ou recurso.
8. Gerar ficha de triagem.
...
```json
{
  "skill": "ep-triagem-inicial-execucao",
  ...
  "resultado": {
    "triagem": {
      ...
      "motivo_urgencia": "",
      "dados_confirmados": {},
      "dados_relativos_a_confirmar": {},
      "riscos": [],
      "oportunidades_iniciais": [],
      "documentos_necessarios": [],
      "primeiras_providencias": []
    }
  },
  "premissas": [],
  "fontes_documentais": [],
...
- A triagem deve ser pragmática e focada em providência, não em parecer longo.
...
Triagem não é parecer completo: é diagnóstico de urgência e coleta inteligente de dados. A skill deve decidir rapidamente o que pode gerar liberdade, evitar prejuízo ou exigir documento imediato.

## Perguntas críticas que a skill deve responder

- Quem está preso e onde?
- Qual é o regime informado e qual é o regime devido?
- Qual é a pena total e há cálculo oficial?
- Qual foi a data da prisão?
- Há falta grave, PAD ou regressão?
- Há trabalho/estudo/remição?
- Há doença ou ameaça?
- Há decisão recente ou prazo?
- Existe benefício já pedido ou indeferido?
- Quais documentos são imprescindíveis nas próximas 24 horas?

## Documentos e dados específicos a procurar

- documentos pessoais mínimos
- número do processo
- print do SEEU/PJe
- atestado de pena se disponível
- relato familiar
- decisão recente
...
3. separar relato de documento
4. identificar alerta de liberdade
5. identificar alerta de saúde
6. identificar alerta de prazo
7. solicitar documentos mínimos
8. definir próximo fluxo

## Armadilhas e erros de alta gravidade

- família informa término de pena sem cálculo
- relato de risco de morte
- decisão recente com prazo recursal
- alvará não cumprido
- cliente em regime mais gravoso
