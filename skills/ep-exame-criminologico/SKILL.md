---
name: ep-exame-criminologico
description: >-
  Use para analisar exigência, laudo, impugnação, complementação ou contraprova de exame
  criminológico. Não use para conclusão definitiva sem autos suficientes, fonte atual ou revisão
  profissional.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-exame-criminologico"]
...
Auditar a legalidade da exigência e a qualidade técnica do exame criminológico, separando fundamentação concreta, metodologia, conclusões genéricas e impacto no benefício.

# Quando usar

- Quando o juiz exige exame criminológico.
- Quando há laudo desfavorável.
- Quando a progressão foi indeferida com base em exame.
- Quando se busca impugnar laudo genérico ou desatualizado.

# Entradas necessárias ou desejáveis

- Decisão que determinou o exame.
- Laudo criminológico completo.
- Atestado de conduta.
- Certidão disciplinar.
- Histórico de trabalho/estudo.
- Decisão que deferiu ou indeferiu benefício.

# Protocolo obrigatório

1. Identificar se a exigência foi fundamentada.
2. Verificar data do fato, lei aplicável e direito intertemporal.
3. Analisar metodologia do laudo.
4. Verificar se houve entrevista, fontes e critérios técnicos.
5. Identificar generalidades, contradições e uso da gravidade abstrata do crime.
6. Comparar laudo com histórico carcerário atual.
7. Apontar necessidade de complementação, nova avaliação ou desconsideração.
8. Mapear tese e instrumento impugnativo.
9. Listar prova favorável a juntar.
10. Entregar parecer de impugnação.
...
```json
{
  "skill": "ep-exame-criminologico",
  "status": "concluido | concluido_com_ressalvas | bloqueado",
  "resultado": {
    "exame_criminologico": {
      "exigencia_questionavel": false,
      "problemas_do_laudo": [],
      "prova_favoravel": [],
      "tese": "",
...
- A skill deve diferenciar laudo tecnicamente desfavorável de laudo juridicamente imprestável.
...
A skill deve analisar tanto a exigência do exame quanto o conteúdo do laudo. O ponto central é evitar decisão baseada em gravidade abstrata, laudo genérico ou metodologia frágil.

## Perguntas críticas que a skill deve responder

- O exame foi exigido por lei atual ou decisão motivada?
- A data do fato importa?
- A decisão é fundamentada?
- O laudo tem metodologia?
- Houve entrevista?
- Há dados atuais?
- A conclusão é genérica?
- Confunde crime com mérito atual?
- Há documentos de conduta favoráveis?
- Qual impugnação cabe?

## Documentos e dados específicos a procurar

- decisão que exige exame
- laudo
- atestado de conduta
- certidão disciplinar
- histórico de trabalho/estudo
...
1. Validar exigência
2. aplicar direito intertemporal
3. analisar metodologia
4. detectar generalidades
5. confrontar com documentos atuais
6. propor complementação/contraprova
7. definir recurso ou pedido

## Armadilhas e erros de alta gravidade

- laudo baseado apenas na gravidade do delito
- ausência de entrevista
- conclusão sem fundamentação
- aplicação retroativa gravosa não discutida
- decisão padronizada
