...
```json
{
  "skill": "ep-regime-aberto-condicoes",
  "case_id": "",
  "task_id": "",
  "modo": "parecer_interno|minuta_protocolavel|checklist|resumo_cliente|saida_estruturada",
  ...
  "resultado_principal": {
    "cabimento": "sim|nao|possivel|bloqueado",
    "requisitos": {
      "objetivo": "",
      "subjetivo": ""
    },
...
- Quais condições foram fixadas?
- São proporcionais e exequíveis?
- Há casa de albergado ou fiscalização alternativa?
- O descumprimento é provado e injustificado?
- Cabe advertência, adequação ou manutenção?
...
- Não analisar benefício sem data-base e cálculo minimamente confiável.
- Separar requisito objetivo de requisito subjetivo.
- Avaliar falta de vaga e pedido subsidiário de harmonização quando o regime pretendido não for implantável.
- Indicar prova subjetiva necessária: conduta, certidão disciplinar, trabalho/estudo, laudo quando relevante.
...
Atrasos no recolhimento por jornada de trabalho; a skill deve estruturar prova, justificação e pedido de ajuste das condições.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["condicoes", "cumprimento", "descumprimentos", "justificativas", "risco_regressao", "pedido"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    {"skill": "ep-matriz-prova-alegacao", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-revisor-probatorio", "motivo": "continuidade técnica recomendada"},
    {"skill": "ep-peca-progressao-regime", "motivo": "continuidade técnica recomendada"}
  ],
  "revisao_humana_obrigatoria": true
}
```
