...
5. PEDIDOS — SEMPRE EM ORDEM SUCESSIVA (eventualidade)
   ...
   b) subsidiariamente, LIBERDADE PROVISÓRIA sem fiança (arts. 310,
      ...
      hipossuficiência, DISPENSA (art. 325, § 1º, I, c/c art. 350) ou
      REDUÇÃO ATÉ 2/3 (art. 325, § 1º, II);
...
| Ignorar a fiança arbitrada inalcançável | Cliente solto "no papel", preso na prática | Requerer dispensa (art. 325, § 1º, I, c/c art. 350) ou redução até 2/3 (art. 325, § 1º, II) na própria audiência — o §1º **não** prevê parcelamento; se for pedir pagamento fracionado, funde-o no art. 282, I e II |
