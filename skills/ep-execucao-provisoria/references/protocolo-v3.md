...
- Há trânsito para acusação ou defesa?
- A guia é provisória?
- Qual benefício pode ser analisado sem agravar situação?
- Há recurso pendente com efeito relevante?
- Há cautela intertemporal?
...
Guia provisória com recurso defensivo pendente; a skill deve limitar conclusões e indicar benefícios possíveis sem prejuízo.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["status_transito", "tipo_guia", "limites", "beneficios_possiveis", "riscos", "providencia"]
  },
  "achados_criticos": [
