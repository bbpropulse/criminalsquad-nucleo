---
name: ep-execucao-provisoria
description: >-
  Analisa execução penal provisória, guia provisória, limites, benefícios, trânsito e cautelas. Não
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-execucao-provisoria"]
...
Executar a competência especializada `ep-execucao-provisoria` em execução penal brasileira, com foco em prova, cálculo quando aplicável, risco, providência concreta e revisão humana.

# Quando usar

- Quando a tarefa envolver analisa execução penal provisória, guia provisória, limites, benefícios, trânsito e cautelas.
