...
- O requisito subjetivo está documentado?
- Há impedimento ou risco?
- Há pedido subsidiário útil?
- Qual peça ou providência resolve?
...
A skill deve separar cabimento seguro, cabimento provável e cabimento bloqueado por documento ausente.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["cabimento", "requisitos", "riscos", "documentos_faltantes", "pedido_recomendado"]
  },
  "achados_criticos": [
