---
name: ep-livramento-condicional
description: >-
  Use para analisar livramento condicional, fração, requisito subjetivo, reparação, condições,
  revogação e estratégia. Não use para conclusão definitiva sem autos suficientes, fonte atual ou
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-livramento-condicional"]
...
Avaliar cabimento de livramento condicional com base em cálculo, conduta, requisitos legais, riscos de revogação e plano de cumprimento em liberdade.

# Quando usar

- Quando a fração de livramento pode estar vencida.
- Antes de pedido de livramento.
- Após falta grave antiga ou recente.
- Quando há dúvida entre progressão e livramento.
- Quando há suporte familiar/trabalho a comprovar.

# Entradas necessárias ou desejáveis

- Cálculo de pena.
- Condenações e reincidência.
- Certidão disciplinar e atestado de conduta.
- Comprovante de residência.
- Proposta de trabalho ou rede familiar.
- Informações sobre reparação do dano, se aplicável.
- Decisões anteriores.

# Protocolo obrigatório

1. Calcular requisito objetivo.
2. Identificar fração aplicável e premissas.
3. Analisar requisito subjetivo.
4. Verificar faltas graves e seus efeitos específicos.
5. Verificar reparação do dano quando exigível e possível.
6. Analisar residência, trabalho e condições realistas.
7. Mapear riscos de revogação.
8. Comparar com progressão, se necessário.
9. Listar documentos faltantes.
10. Entregar parecer e estratégia de pedido.
...
```json
{
  "skill": "ep-livramento-condicional",
...
- A resposta deve evitar pedido de livramento sem plano mínimo de cumprimento.
...
Livramento condicional exige cálculo, comportamento e plano mínimo de cumprimento. A skill deve diferenciar lapso objetivo, requisito subjetivo e condições práticas.

## Perguntas críticas que a skill deve responder

- Qual fração aplicável?
- Qual data do lapso?
- Há reincidência?
- Há crime impeditivo ou regra especial?
- Há falta grave recente?
- Há bom comportamento?
- Há residência?
- Há trabalho/suporte?
- Há reparação do dano exigível?
- Há risco de condições excessivas?
...
- comprovante de residência
- proposta de trabalho/suporte familiar
- sentença
- certidão de reparação se relevante

## Protocolo ampliado de alta performance

1. Calcular lapso
2. validar fração
3. validar requisito subjetivo
4. analisar faltas
5. analisar residência/trabalho
6. mapear condições
7. prever objeções
...
- falta grave tratada como interrupção automática do lapso sem verificar efeito específico
- ausência de comprovante de residência
- condições desproporcionais não questionadas
- cálculo de lapso errado
