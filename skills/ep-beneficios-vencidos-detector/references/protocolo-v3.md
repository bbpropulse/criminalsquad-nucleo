...
- Qual premissa matemática/jurídica é decisiva?
- Há divergência com cálculo oficial?
- Há cenário alternativo?
- Qual efeito prático em dias?
...
A skill deve gerar memória matemática auditável e cenários quando houver controvérsia.
...
```json
{
  ...
  "resultado_principal": {
    "campos_especializados": ["premissas", "memoria_calculo", "cenarios", "divergencias", "impacto_pratico"]
  },
  "achados_criticos": [
  ...
  "proximas_skills_sugeridas": [
    ...
    {"skill": "ep-peca-habeas-corpus-execucao", "motivo": "continuidade técnica recomendada"}
  ],
  "revisao_humana_obrigatoria": true
}
```
