---
name: ep-beneficios-vencidos-detector
description: >-
  Use para detectar progressão, livramento, remição, indulto, comutação, término, alvará ou excesso
  de execução vencidos. Não use para conclusão definitiva sem autos suficientes, fonte atual ou
...
metadata:
  ...
  next_skills_sugeridas:
    ...
    - ep-peca-habeas-corpus-execucao
  type: "prompt"
  schema_version: "5"
  quality_profile: "legal-analysis"
  contract_version: "5.0.0"
  quality_status: "contracted"
  eval_case_ids: ["csq-v5-ep-beneficios-vencidos-detector"]
...
Encontrar oportunidades executórias já vencidas ou negligenciadas, com indicação de urgência, documentos e peça recomendada.

# Quando usar

- Na triagem de caso novo.
- Na revisão periódica de carteira.
- Após auditoria de cálculo.
- Quando a família suspeita que já havia direito a benefício.
...
- Remições.
- Decreto de indulto/comutação aplicável, se houver.
- Decisões e pendências.

# Protocolo obrigatório

1. Verificar progressão vencida.
2. Verificar livramento vencido.
3. Verificar remição pendente que altera datas.
4. Verificar indulto/comutação possível conforme decreto aplicável.
5. Verificar término de pena e necessidade de alvará.
6. Verificar regime mais gravoso por falta de vaga.
7. Verificar decisão favorável não cumprida.
8. Classificar urgência e impacto.
9. Indicar peça ou providência adequada.
10. Listar prova necessária para cada oportunidade.
...
- A skill deve priorizar oportunidades que podem produzir liberdade, regime menos gravoso ou redução de pena.
...
Esta skill procura oportunidades perdidas. Deve cruzar cálculo, documentos e eventos para encontrar pedidos que já poderiam ter sido formulados.
...
- Livramento venceu?
- Término venceu?
- Remição pendente antecipa benefício?
- Indulto/comutação cabem?
- Há alvará pendente?
- Regime mais gravoso persiste?
- Há decisão favorável não cumprida?
- Há exame atrasando benefício?
- Qual providência é mais urgente?
...
- remições
- decreto de indulto se aplicável

## Protocolo ampliado de alta performance

1. Consolidar marcos
2. verificar progressão
3. verificar livramento
4. verificar término
5. verificar remições
6. verificar indulto/comutação
7. verificar cumprimento de decisões
8. priorizar oportunidades
9. indicar peças

## Armadilhas e erros de alta gravidade

- benefício vencido sem requisito subjetivo mínimo
- decreto anual não verificado
- cálculo desatualizado
- documento de conduta ausente
