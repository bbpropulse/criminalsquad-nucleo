---
name: ep-peca-remicao
description: >-
  Use para redigir pedido de homologação, reconhecimento ou retificação de remição por trabalho,
  estudo, leitura ou curso. Não use para decisão final, assinatura, protocolo ou citação não
  verificada.
metadata:
  lifecycle: "preview"
  ...
  eval_case_ids: ["csq-v5-ep-peca-remicao"]
...
Produzir minuta de pedido de remição com identificação das atividades, documentos, dias remíveis e impacto no cálculo.

# Quando usar

- Quando há remição pendente.
- Quando certificados não foram lançados.
- Quando houve erro ou perda indevida de remição.
- Quando remição pode antecipar benefício.

# Entradas necessárias ou desejáveis

- Cálculo de remição.
- Certificados, relatórios e comprovantes.
- Cálculo oficial.
- Atestado de pena.
- Decisões anteriores de homologação/perda.
- Impacto no benefício.

# Protocolo obrigatório

1. Identificar atividade remível e período.
2. Apresentar documentos comprobatórios.
3. Calcular dias de remição.
4. Separar dias já homologados de pendentes.
5. Demonstrar impacto no cálculo e benefício.
6. Fundamentar conforme norma vigente e jurisprudência verificada.
7. Pedir homologação ou retificação.
8. Pedir atualização do cálculo e do atestado.
9. Pedir análise de benefício se a remição alterar lapso.
...
A skill deve produzir pedido de remição com padrão de criminalista sênior: objetivo, documentado, com cálculo quando aplicável, tese clara, enfrentamento de riscos e pedido operacional executável.
...
- contar remição sem certificado
- não pedir atualização do atestado
- misturar remição pendente com homologada
- fato sem fonte
