...
> **Lição central:** o processo **penal** conta prazo em **dias corridos** — o caput do art. 798 do CPP diz que os prazos são contínuos e **não se interrompem por férias, domingo ou dia feriado**. Sábado **não está no texto** e não precisa estar: contagem contínua não para em dia nenhum. Isso é **diferente** do processo civil (dias úteis, CPC 219), e confundir os dois é a causa nº 1 de recurso intempestivo.

> **Sábado no vencimento — cuidado com o fundamento.** O § 3º prorroga o prazo que terminar em "domingo ou dia feriado"; **sábado também não está lá**. Quando o vencimento cai num sábado, a prorrogação se apoia na **ausência de expediente forense**, não no § 3º. O motor prorroga (o resultado é o mesmo) e emite aviso de premissa — **não cite o § 3º como fundamento da prorrogação por sábado numa peça**.
