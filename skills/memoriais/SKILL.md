...
> DESCLASSIFICAÇÃO DO FEMINICÍDIO (ART. 121-A) PARA O ART. 121 DO CP,
> POR NÃO CONFIGURADAS AS RAZÕES DA CONDIÇÃO DO SEXO FEMININO
> (ELEMENTAR DO ART. 121-A, §1º, I).
...
- **Falta de instituto despenalizador** — ANPP (art. 28-A CPP), transação penal (art. 76, ***caput***, Lei 9.099/95), suspensão condicional do processo (art. 89, Lei 9.099/95). *O §2º do art. 76 é a lista de **vedações** à transação, não a sua base — citá-lo como fundamento do instituto é invocar o dispositivo que o nega.*
...
- **Bis in idem** entre a tipificação autônoma (art. 129, §13) e a agravante do art. 61, II, "f" — **atenção ao Tema 1197 STJ**, que rejeita a tese quanto a essa agravante (confira o teor e a vigência pela best-practice `verificacao-citacoes` antes de citar).
  > ⚠️ **Não inclua o art. 121-A neste par.** Depois da Lei 14.994/2024 o feminicídio é **tipo autônomo**, não qualificadora do art. 121: o §1º do art. 121-A **define a elementar** ("considera-se que há razões da condição do sexo feminino quando..."). Logo, não há qualificadora a decotar — o pedido útil é a **desclassificação** do art. 121-A para o art. 121, com reflexo em pena, hediondez e quesitação no júri. Pedir "afastamento da qualificadora do 121-A" é pedido sem objeto, e a capitulação permanece intacta.
