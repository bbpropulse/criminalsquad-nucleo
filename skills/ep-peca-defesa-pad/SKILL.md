---
name: ep-peca-defesa-pad
description: >-
  Use para redigir defesa em PAD, impugnação de falta grave ou pedido de não homologação. Não use
...
metadata:
  ...
  eval_case_ids: ["csq-v5-ep-peca-defesa-pad"]
...
Produzir defesa técnica contra imputação disciplinar, atacando procedimento, prova, tipicidade, individualização, proporcionalidade e efeitos executórios.

# Quando usar

- Durante PAD.
- Após relatório de ocorrência.
- Antes da homologação judicial.
- Depois da homologação, para impugnação ou agravo.
- Quando falta grave afeta benefício.

# Entradas necessárias ou desejáveis

- Relatório de ocorrência.
- Portaria e peças do PAD.
- Provas, depoimentos, vídeos e defesa anterior.
- Decisão administrativa e judicial, se houver.
- Certidão disciplinar.
- Cálculo com efeitos da falta.

# Protocolo obrigatório

1. Apresentar síntese da imputação.
2. Arguir nulidades procedimentais.
3. Atacar fragilidades probatórias.
4. Discutir tipicidade e individualização.
5. Enfrentar proporcionalidade da sanção.
6. Pedir produção ou complementação de prova, se necessário.
7. Pedir absolvição/não homologação.
8. Pedir subsidiariamente desclassificação ou limitação dos efeitos.
9. Pedir preservação de remição/data-base quando cabível.
...
A skill deve produzir defesa em PAD ou impugnação de falta grave com padrão de criminalista sênior: objetivo, documentado, com cálculo quando aplicável, tese clara, enfrentamento de riscos e pedido operacional executável.
...
- defesa genérica
- não pedir provas
- não atacar efeitos na data-base/remição
- fato sem fonte
