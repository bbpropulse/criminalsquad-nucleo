...
> **Qualidade da escrita:** carregue e aplique a skill `redacao-persuasiva-criminal` (`skills/redacao-persuasiva-criminal/SKILL.md`) — a rubrica de redação persuasiva é o padrão da peça.
...
- **Skill da peça:** Carrega a skill `resposta-a-acusacao` (`skills/resposta-a-acusacao/SKILL.md`) como base estrutural da peça.
