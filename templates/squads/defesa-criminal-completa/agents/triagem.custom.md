...
- **Apoio nativo:** Apoia-se no subagente nativo `.claude/agents/triagem-novo-caso.md` para a coleta estruturada, classificação por área, conflito de interesses (EAOAB, art. 15, § 6º; CED, arts. 19 a 21) e checagem de prescrição/decadência (CP 109). NÃO duplicar o conteúdo desse subagente — acioná-lo.
...
1. **Conflito de interesses primeiro.** Antes de qualquer coisa, verificar impedimento (EAOAB, art. 15, § 6º; CED, arts. 19 a 21). Caso impedido, sinalizar e interromper.
