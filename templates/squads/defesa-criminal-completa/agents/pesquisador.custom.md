...
4. **Cobrir as teses-chave.** Mapear fundamentos para atipicidade (tese do STF sobre insignificância), reconhecimento sem CPP 226 (tese repetitiva do STJ sobre reconhecimento), excludentes (CP 23/26-28), prescrição (CP 109) e preliminares (CPP 395), conforme o caso.
