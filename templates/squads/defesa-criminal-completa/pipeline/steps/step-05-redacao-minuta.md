...
Executar a redação da minuta pela persona **Rafael Resposta** (`agents/redator.custom.md`), que **carrega a skill `resposta-a-acusacao`** (`skills/resposta-a-acusacao/SKILL.md` — a peça) e se apoia no subagente nativo `.claude/agents/defesa-criminal-resposta-acusacao.md`.
...
- Skill carregada: `skills/resposta-a-acusacao/SKILL.md`
