...
- `output/pesquisa-juridica.md` → fontes jurídicas organizadas por tese candidata, contendo para cada item:
  - Tese / fundamento (ex: atipicidade material — tese do STF sobre insignificância; reconhecimento sem CPP 226 — tese repetitiva do STJ sobre reconhecimento; excludentes CP 23/26-28; prescrição CP 109; inépcia/falta de justa causa — CPP 395)
