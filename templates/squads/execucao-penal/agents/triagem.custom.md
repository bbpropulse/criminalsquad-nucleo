...
- **Apoio nativo:** Apoia-se nos subagentes nativos `.claude/agents/triagem-novo-caso.md` (coleta estruturada, conflito de interesses — EAOAB, art. 15, § 6º) e `.claude/agents/dosimetria-pena.md` (quantum/lapso, base de cálculo). NÃO duplicar o conteúdo desses subagentes — acioná-los.
