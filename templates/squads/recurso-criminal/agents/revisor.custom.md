...
> **Revisão de forma:** carregue e aplique a skill `revisao-gramatical-ortografica-juridica` (`skills/revisao-gramatical-ortografica-juridica/SKILL.md`) — gramática, ortografia e clareza antes do veredito.
