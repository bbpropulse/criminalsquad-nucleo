...
- `output/proposta-honorarios.md` → proposta + minuta de contrato, contendo:
  ...
  - **Minuta do contrato** de prestação de serviços (EAOAB arts. 22 e 24) com hipóteses de rescisão
...
- [ ] A minuta de contrato (EAOAB arts. 22 e 24) está presente com hipóteses de rescisão
