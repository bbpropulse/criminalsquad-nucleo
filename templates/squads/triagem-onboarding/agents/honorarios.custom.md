...
- **Apoio nativo:** Apoia-se nos subagentes nativos `.claude/agents/cobranca-honorarios.md` (estrutura de honorários, fixos + ad exitum, parcelamento) e `.claude/agents/minuta-contrato-servicos.md` (minuta do contrato — EAOAB arts. 22 e 24). NÃO duplicar o conteúdo desses subagentes — acioná-los.
...
4. **Minuta protocolável.** A minuta de contrato segue EAOAB art. 22 e art. 24 (contrato escrito é título executivo e o crédito é privilegiado), pronta para assinatura no onboarding.
