...
execution: subagent
skills:
  - revisao-gramatical-ortografica-juridica
  - publicacao-redes
---

> **Correção do texto:** carregue e aplique a skill `revisao-gramatical-ortografica-juridica` (`skills/revisao-gramatical-ortografica-juridica/SKILL.md`) antes de emitir o veredito. Erro de gramática ou ortografia em post público de advogado é dano de imagem imediato e irreversível — o conteúdo fica indexado. Isso NÃO substitui o Gate Ético, que continua soberano: texto impecável com veto ético é REJECT do mesmo jeito.
