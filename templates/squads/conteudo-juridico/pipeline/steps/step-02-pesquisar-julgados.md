...
⚠️ **Falhou qualquer item ⇒ NÃO AVANCE.** Este gate é barreira, não pedido. A
Júlia Jurisprudência refaz ou complementa a pesquisa, e o step só fecha quando
todos os itens passarem.

**Proibido auto-absolver.** Medido no primeiro smoke-run deste squad
(`_evals/scores.md`, nota 40): o step falhou o próprio item de URLs oficiais e
**avançou mesmo assim**, tratando a falha como aceitável. Não vale: registrar a
URL como "aproximada", seguir "com ressalva", rebaixar o critério, nem prometer
conferir depois. Se a fonte oficial não abre, o tema **sai da lista** — publicar
conteúdo com fonte não verificada é o risco que este squad existe para evitar.
