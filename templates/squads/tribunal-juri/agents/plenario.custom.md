...
execution: inline
skills:
  - redacao-persuasiva-criminal
  - juri-plenario-debates
  - juri-quesitacao
---

> **Qualidade da escrita:** carregue e aplique a skill `redacao-persuasiva-criminal` (`skills/redacao-persuasiva-criminal/SKILL.md`) — a rubrica de redação persuasiva é o padrão do material de plenário. Aqui ela pesa mais que em qualquer outra peça: o destinatário são sete jurados leigos decidindo por convicção íntima, e o texto é falado em voz alta, não lido em gabinete.
