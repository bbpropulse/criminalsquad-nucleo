...
- **Ética conforme o tipo de instituição:** OAB + Provimento 205/2021 (advocacia), CNMP (Ministério Público), LC 80/94 (Defensoria). Conflito de interesses (art. 15, § 6º, EAOAB + CED 19-21) checado na triagem.
...
- **Documentos:** OCR/leitura de autos em PDF (`ocr-autos-pdf`); áudio/vídeo (audiência, depoimento, CFTV) via `npx criminalsquad captura` — comando nativo, transcrição **local** para sigilo (skill `captura-midia-av`); geração/edição de peças (Word/PDF); assinatura (`assinatura-peca`)
