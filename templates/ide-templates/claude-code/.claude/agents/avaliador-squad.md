...
4. **Nota geral.** `nota = round(100 * soma_pontos / (2 * nº_critérios))`. Verdict: **APROVADO** se nota ≥ 80 **e** nenhum critério em NÃO ATENDE; senão **Revisão humana necessária**.
...
avaliacao:
  ...
  nota: 0-100
  verdict: APROVADO | Revisão humana necessária
  criterios:
